...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/cdn.jsdelivr.net/npm/%40mdi/font%404.8.95/css/materialdesignicons.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css') }}">
...
<body>
    ...
    @if (request()->routeIs('request-quote'))
        <script src="{{ asset('assets/code.jquery.com/jquery-3.4.1.min.js') }}"></script>
        <script src="{{ asset('assets/cdn.jsdelivr.net/npm/popper.js%401.16.0/dist/umd/popper.min.js') }}"></script>
        <script src="{{ asset('assets/js/stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js') }}"></script>
