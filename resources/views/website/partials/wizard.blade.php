                ...
                <div class="purpose-radios-wrapper">
                    <div class="purpose-radio">
                        ...
                        <label for="branding" class="purpose-radio-label">
                            <span class="label-icon">
                                <img src="assets/images/icons/p.svg" alt="branding" class="label-icon-default">
                                <img src="assets/images/icons/p.svg" alt="branding" class="label-icon-active">
                            </span>
                    ...
                    <div class="purpose-radio">
                        ...
                        <label for="mobile-design" class="purpose-radio-label">
                            <span class="label-icon">
                                <img src="assets/images/icons/c.svg" alt="branding" class="label-icon-default">
                                <img src="assets/images/icons/c.svg" alt="branding" class="label-icon-active">
                            </span>
