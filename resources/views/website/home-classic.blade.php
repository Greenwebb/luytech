...
<!-- Mirrored from 7oroof.com/demos/optime/home-classic.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 21:25:52 GMT -->
<head>
  <meta charset="UTF-8" />
            ...
            <div class="d-flex flex-wrap">
              <ul class="contact__list list-unstyled">
                ...
                <li>
                  ...
                  <div>
                    <span>Email Us:</span><strong><a href="https://7oroof.com/cdn-cgi/l/email-protection#b8d7c8ccd1d5ddf88fd7cad7d7de96dbd7d5"><span class="__cf_email__" data-cfemail="a3ccd3d7cacec6e394ccd1ccccc58dc0ccce">[email&#160;protected]</span></a></strong>
                  </div>
                </li>
                <li>
          ...
          <div class="container">
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav__item with-dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <!-- /.nav-item -->
                    <li class="nav__item"><a href="global-locations.php" class="nav__item-link">Global Locations</a>
                    </li>
                    <!-- /.nav-item -->
                      ...
                      <div class="row mx-0">
                        <div class="col-sm-6 dropdown-menu-col">
                          ...
                          <ul class="nav flex-column">
                            ...
                            <li class="nav__item"><a class="nav__item-link" href="single-service.php">Packaging</a>
                            </li>
                            <!-- /.nav-item -->
                          </ul>
                        </div><!-- /.col-sm-6 -->
                        <div class="col-sm-6 dropdown-menu-col">
                          ...
                          <ul class="nav flex-column">
                            ...
                            <li class="nav__item"><a class="nav__item-link" href="single-industry.php">Oil & Gas</a>
                            </li>
                            <!-- /.nav-item -->
                          </ul>
                        </div><!-- /.col-sm-6 -->
                ...
                <li class="nav__item with-dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <!-- /.nav-item -->
                    <li class="nav__item"><a href="blog-single-post.php" class="nav__item-link">blog single post</a>
                    </li>
                    <!-- /.nav-item -->
                    <li class="nav__item"><a href="case-studies.php" class="nav__item-link">case studies</a></li>
                    <!-- /.nav-item -->
                    <li class="nav__item"><a href="case-studies-single.php" class="nav__item-link">case study
                        Single</a>
                    </li>
                    <!-- /.nav-item -->
                  </ul><!-- /.dropdown-menu -->
            ...
            <div class="navbar-modules d-none d-lg-block">
              <ul class="list-unstyled d-flex align-items-center modules__btns-list">
                ...
                <li>
                  <a href="{{ route('request-quote') }}" class="btn btn__primary btn__hover2 module__btn-request">
          ...
          <div class="col-sm-12 col-md-12 col-lg-6 offset-lg-6">
            <div class="testimonial-panel-wrap">
              <div class="carousel owl-carousel carousel-arrows" data-slide="1" data-slide-md="1" data-slide-sm="1"
                ...
                <div class=" testimonial-item">
                  <div class="testimonial__content">
                    <p class="testimonial__desc">Luytech Motors International customer service is some of the best
                      we
          ...
          <div class="col-sm-12 col-md-6 col-lg-4">
            <div class="blog-item">
              ...
              <div class="blog__content">
                ...
                <p class="blog__desc">Global provider connected products for consumers, and enterprises Countrywide,
          ...
          <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-4 footer__widget footer__widget-about">
              <div class="footer__widget-content">
                ...
                <ul class="contact__list list-unstyled">
                  <li><span>Email:</span><span><a href="https://7oroof.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="3f704f4b56525a7f08504d505059115c5052">[email&#160;protected]</a></span></li>
...
<!-- Mirrored from 7oroof.com/demos/optime/home-classic.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 21:25:53 GMT -->
</html>