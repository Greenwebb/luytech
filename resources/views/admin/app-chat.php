...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/app-chat.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:04 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
                        ...
                        <div class="offcanvas-body p-9">
                          ...
                          <div class="files-chat">
                            ...
                            <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between mb-9">
                              <div class="d-flex align-items-center gap-3">
                                <div class="rounded-1 bg-light p-6">
                                  <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/chat/icon-figma.svg" alt=""  width="24" height="24">
                                </div>
                                <div>
                            ...
                            <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between mb-9">
                              <div class="d-flex align-items-center gap-3">
                                <div class="rounded-1 bg-light p-6">
                                  <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/chat/icon-chrome.svg" alt=""  width="24" height="24">
                                </div>
                                <div>
                                  <h6 class="fw-semibold">about.html</h6>
                                  <div class="d-flex align-items-center gap-3 fs-2 text-muted"><span>2 MB</span><span>2 Dec 2023</span></div>
                                </div>
                              </div>
                              <span class="position-relative nav-icon-hover download-file">
                            ...
                            <a href="javascript:void(0)" class="hstack gap-3 file-chat-hover justify-content-between">
                              <div class="d-flex align-items-center gap-3">
                                <div class="rounded-1 bg-light p-6">
                                  <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/chat/icon-javascript.svg" alt=""  width="24" height="24">
                                </div>
                                <div>
...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/app-chat.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:05 GMT -->
</html>