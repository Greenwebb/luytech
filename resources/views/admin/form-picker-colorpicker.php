...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-picker-colorpicker.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:53:34 GMT -->
<head>
  <!-- --------------------------------------------------- -->
  <!-- Title -->
  <!-- --------------------------------------------------- -->
  ...
  <link rel="stylesheet" href="../../dist/libs/%40claviska/jquery-minicolors/jquery.minicolors.css">
  <!-- --------------------------------------------------- -->
  <!-- Core Css -->
  <!-- --------------------------------------------------- -->
...
<body>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-sidebartype="full"
    ...
    <div class="body-wrapper">
                  ...
                  <div class="col-4 ms-n4">
                    <div class="position-relative p-7 border-start h-100">
                      ...
                      <ul class="">
                        ...
                        <li class="mb-3">
                          <a class="fw-semibold text-dark bg-hover-primary text-decoration-none text-decoration-none text-decoration-none text-decoration-none" href="authentication-error.php">404 Error
                            Page</a>
                        </li>
                        <li class="mb-3">
                        ...
                        <li class="mb-3">
                          <a class="fw-semibold text-dark bg-hover-primary text-decoration-none text-decoration-none text-decoration-none text-decoration-none" href="page-user-profile.php">User
                            Application</a>
                        </li>
                        <li class="mb-3">
                          <a class="fw-semibold text-dark bg-hover-primary text-decoration-none text-decoration-none text-decoration-none text-decoration-none" href="page-account-settings.php">Account
                            Settings</a>
                        </li>
                      </ul>
                    </div>
      ...
      <div class="container-fluid">
        <div class="card bg-light-info shadow-none position-relative overflow-hidden">
          <div class="card-body px-4 py-3">
              <div class="row align-items-center">
                  <div class="col-9">
                      <h4 class="fw-semibold mb-8">Picker-Colorpicker</h4>
        ...
        <div class="row">
          <div class="col-12">
            <h4 class="card-title mb-3">Minicolors</h4>
            <div class="card">
              ...
              <div class="card-body">
                <div class="mb-3">
                  <label class="font-weight-medium mb-1" for="hue-demo">Hue (default)</label>
                  <input type="text" id="hue-demo" class="form-control demo" data-control="hue" value="#ff6161" />
                </div>
                <div class="mb-3">
                  <label class="font-weight-medium mb-1" for="saturation-demo">Saturation</label>
                  <input type="text" id="saturation-demo" class="form-control demo" data-control="saturation"
                    value="#0088cc" />
                </div>
                <div class="mb-3">
                  <label class="font-weight-medium mb-1" for="brightness-demo">Brightness</label>
                  <input type="text" id="brightness-demo" class="form-control demo" data-control="brightness"
                    value="#00ffff" />
                </div>
                <div class="mb-3">
                  <label class="font-weight-medium mb-1" for="wheel-demo">Wheel</label>
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                <div class="mb-3">
                  <label class="font-weight-medium mb-1" for="text-field">Text field</label>
                  <br />
                  <input type="text" id="text-field" class="form-control demo" value="#70c24a" />
                </div>
                <div class="mb-3">
                  <label class="font-weight-medium mb-1" for="hidden-input">Hidden Input</label>
                  <br />
                  <input type="hidden" id="hidden-input" class="demo" value="#db913d" />
                </div>
                <div class="mb-3">
                  <label class="font-weight-medium mb-1" for="inline">Inline</label>
                  <br />
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-6 col-sm-12">
                    <div class="mb-3">
                      <label class="font-weight-medium mb-1" for="position-bottom-left">bottom left (default)</label>
                      <input type="text" id="position-bottom-left" class="form-control demo" data-position="bottom left"
                        value="#0088cc" />
                    </div>
                    <div class="mb-3">
                      <label class="font-weight-medium mb-1" for="position-top-left">top left</label>
                  ...
                  <div class="col-lg-6 col-sm-12">
                    <div class="mb-3">
                      <label class="font-weight-medium mb-1" for="position-bottom-right">bottom right</label>
                      <input type="text" id="position-bottom-right" class="form-control demo"
                        data-position="bottom right" value="#0088cc" />
                    </div>
                    <div class="mb-3">
                      <label class="font-weight-medium mb-1" for="position-top-right">top right</label>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-sm-12 col-md-6">
                    <div class="mb-3">
                      <label class="font-weight-medium mb-1" for="rgb">RGB</label>
                      <h6 class="help-block text-muted fw-light">
                  ...
                  <div class="col-sm-12 col-md-6">
                    <div class="mb-3">
                      <label class="font-weight-medium mb-1" for="rgba">RGBA</label>
                      <h6 class="help-block text-muted fw-light">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-sm-12 col-md-6">
                    <div class="mb-3">
                      <label class="font-weight-medium mb-1" for="opacity">Opacity</label>
                      <h6 class="help-block text-muted fw-light">
                  ...
                  <div class="col-sm-12 col-md-6">
                    <div class="mb-3">
                      <label class="font-weight-medium mb-1" for="keywords">Keywords</label>
                      <h6 class="help-block text-muted fw-light">
                ...
                <div class="row">
                  <div class="col-sm-12 col-md-6">
                    <div class="mb-3">
                      <label class="font-weight-medium mb-1" for="default-value">Default Value</label>
                      <h6 class="help-block text-muted fw-light">
                  ...
                  <div class="col-sm-12 col-md-6">
                    <div class="mb-3">
                      <label class="font-weight-medium mb-1" for="letter-case">Letter Case</label>
                      <h6 class="help-block text-muted fw-light">
                ...
                <div class="row">
                  <div class="col-sm-12 col-md-6">
                    <div class="mb-3">
                      <label class="font-weight-medium mb-1" for="input-group">Input Groups</label>
                      <h6 class="help-block text-muted fw-light">
                  ...
                  <div class="col-sm-12 col-md-6">
                    <div class="mb-3">
                      <label class="font-weight-medium mb-1" for="more-input-group">More Input Groups</label>
                      <h6 class="help-block text-muted fw-light">
                ...
                <div class="row">
                  <div class="col-sm-12 col-md-6">
                    <div class="mb-3">
                      <label class="font-weight-medium mb-1" for="letter-case">Swatches</label>
                      <h6 class="help-block text-muted fw-light">
                  ...
                  <div class="col-sm-12 col-md-6">
                    <div class="mb-3">
                      <label class="font-weight-medium mb-1" for="letter-case">Swatches and opacity</label>
                      <h6 class="help-block text-muted fw-light">
  ...
  <!-- ---------------------------------------------- -->
  <script src="../../dist/libs/jquery-asColor/dist/jquery-asColor.min.js"></script>
  <script src="../../dist/libs/jquery-asGradient/dist/jquery-asGradient.min.js"></script>
  <script src="../../dist/libs/jquery-asColorPicker/dist/jquery-asColorPicker.min.js"></script>
  <script src="../../dist/libs/%40claviska/jquery-minicolors/jquery.minicolors.min.js"></script>
  <script>
    $(".demo").each(function () {
      //
...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-picker-colorpicker.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:53:37 GMT -->
</html>