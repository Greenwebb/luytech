...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/ui-breadcrumb.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:49 GMT -->
<head>
  <!-- --------------------------------------------------- -->
  <!-- Title -->
  <!-- --------------------------------------------------- -->
              ...
              <div class="card w-100">
                <div class="card-body">
                  ...
                  <nav aria-label="breadcrumb" class="mb-1">
                    <ol class="breadcrumb bg-light-info px-3 py-2 rounded">
                  ...
                  <nav aria-label="breadcrumb" class="mb-1">
                    <ol class="breadcrumb bg-light-primary px-3 py-2 rounded">
                      <li class="breadcrumb-item">
                  ...
                  <nav aria-label="breadcrumb" class="mb-1">
                    <ol class="breadcrumb bg-light-warning px-3 py-2 rounded">
                      <li class="breadcrumb-item">
                  ...
                  <nav aria-label="breadcrumb" class="mb-1">
                    <ol class="breadcrumb bg-light-danger px-3 py-2 rounded">
                      <li class="breadcrumb-item">
                      ...
                      <li class="breadcrumb-item active text-danger font-medium" aria-current="page">
                        Data
                      </li>
                    </ol>
                  </nav>
                  <nav aria-label="breadcrumb" class="mb-1">
                    <ol class="breadcrumb bg-light-success px-3 py-2 rounded">
                      <li class="breadcrumb-item">
                      ...
                      <li class="breadcrumb-item active text-success font-medium" aria-current="page">
                        Data
                      </li>
                    </ol>
                  </nav>
