...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-mask.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:53:29 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
          ...
          <div class="row">
            <div class="col-sm-12 col-lg-12">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="mb-3">
                    <label class="font-weight-medium fs-3 mb-1">Date Mask
                  ...
                  <div class="mb-3">
                    <label class="font-weight-medium fs-3 mb-1">Phone / xEx
                  ...
                  <div class="mb-3">
                    <label class="font-weight-medium fs-3 mb-1">Email<small class="text-muted">xxx@xxx.xxx</small>
                    </label>
                  ...
                  <div class="mb-3">
                    <label class="font-weight-medium fs-3 mb-1">RTL attribute<small
                        class="text-muted">dd/mm/yyyy</small>
                    </label>
                    <input type="text" class="form-control date-inputmask" id="date-mask-rtl" placeholder="Enter Date"
                      style="text-align: right" />
                  </div>
                  <div class="mb-3">
                    <label class="font-weight-medium fs-3 mb-1">3 Number and 3 Lettter<small
                  ...
                  <div class="mb-3">
                    <label class="font-weight-medium fs-3 mb-1">Date and Time in Once<small
...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-mask.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:53:32 GMT -->
</html>
