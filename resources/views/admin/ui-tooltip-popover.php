...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/ui-tooltip-popover.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:45 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-md-flex align-items-center button-group">
                      <button
                        type="button"
                        class="me-2 btn btn-light-info text-info font-medium"
                      ...
                      <button
                        type="button"
                        class="me-2 btn btn-light-primary text-primary font-medium"
                        data-bs-toggle="tooltip"
                      ...
                      <button
                        type="button"
                        class="me-2 btn btn-light-success text-success font-medium"
                        data-bs-toggle="tooltip"
                      ...
                      <button
                        type="button"
                        class="me-2 btn btn-light-danger text-danger font-medium"
                        data-bs-toggle="tooltip"
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-md-flex align-items-center button-group">
                      <button
                        type="button"
                        class="me-2 btn btn-light-info text-info d-flex align-items-center font-medium"
                      ...
                      <button
                        type="button"
                        class="me-2 btn btn-light-primary text-primary d-flex align-items-center font-medium"
                        data-bs-container="body"
                        data-bs-toggle="popover"
                        data-bs-placement="right"
                        data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."
                      ...
                      <button
                        type="button"
                        class="me-2 btn btn-light-success text-success d-flex align-items-center font-medium"
                        data-bs-container="body"
                        data-bs-toggle="popover"
                        data-bs-placement="bottom"
                        data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."
                      ...
                      <button
                        type="button"
                        class="me-2 btn btn-light-danger text-danger d-flex align-items-center font-medium"
                        data-bs-container="body"
                        data-bs-toggle="popover"
                        data-bs-placement="left"
                        data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."
              ...
              <div class="col-lg-6">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <a
                      tabindex="0"
                      class="btn btn-light-danger d-inline-flex align-items-center text-danger font-medium"
                      role="button"
                      data-bs-toggle="popover"
                      data-bs-trigger="focus"
                      title="Dismissible popover"
                      data-bs-content="And here's some amazing content. It's very engaging. Right?"
                      ><i class="ti ti-alert-octagon me-2 fs-4"></i>Dismissible popover</a
                    >
                  </div>
                </div>
                <!-- ---------------------
                                                    end Dismiss on next click
                                                ---------------- -->
              </div>
              <div class="col-lg-6">
                <!-- ------------------------------------------------ -->
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    >
                      <button
                        class="btn btn-light-primary text-primary font-medium d-inline-flex align-items-center"
