...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-bootstrap-touchspin.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:53:13 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
    ...
    <!-- --------------------------------------------------- -->
    <link rel="stylesheet" href="../../dist/libs/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.css">
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
      ...
      <div class="body-wrapper">
        ...
        <div class="container-fluid">
          ...
          <section class="bootstrap-touchspin">
            <p>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="mb-4">
                      <h5 class="mb-0">Touchspin With Button (small)</h5>
                    </div>
                    <form class="mt-3">
                      <div class="form-group">
  ...
  <div class="offcanvas offcanvas-end customizer" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" data-simplebar="">
    ...
    <!-- ---------------------------------------------- -->
    <script src="../../dist/libs/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.js"></script>
    <script src="../../dist/js/forms/form-bootstrap-touchspin.init.js"></script>
  </body>

<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-bootstrap-touchspin.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:53:14 GMT -->
</html>
