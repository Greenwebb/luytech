...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/ui-modals.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:42 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
          ...
          <div class="card bg-light-info shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
              <div class="row align-items-center">
                <div class="col-9">
                  <h4 class="fw-semibold mb-8">Modal</h4>
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-md-flex button-group">
                      <div>
                        ...
                        <!-- ------------------------------------------ -->
                        <button
                          class="btn me-1 mb-1 btn-light-warning text-warning btn-lg px-4 fs-4 font-medium"
                      ...
                      <div>
                        ...
                        <!-- ------------------------------------------ -->
                        <button
                          class="btn me-1 mb-1 btn-light-primary text-primary btn-lg px-4 fs-4 font-medium"
                          data-bs-toggle="modal"
                      ...
                      <div>
                        ...
                        <!-- ------------------------------------------ -->
                        <button
                          class="btn me-1 mb-1 btn-light-danger text-danger btn-lg px-4 fs-4 font-medium"
                          data-bs-toggle="modal"
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="button-group">
                      ...
                      <button
                        type="button"
                        class="btn mb-1 btn-light-primary text-primary btn-lg px-4 fs-4 font-medium"
                        data-bs-toggle="modal"
                      ...
                      <button
                        type="button"
                        class="btn mb-1 btn-light-warning text-warning btn-lg px-4 fs-4 font-medium"
                        data-bs-toggle="modal"
                        data-bs-target="#scroll-long-outer-modal"
                      >
                      ...
                      <button
                        type="button"
                        class="btn mb-1 btn-light-success text-success btn-lg px-4 fs-4 font-medium"
                        data-bs-toggle="modal"
                      ...
                      <button
                        type="button"
                        class="btn mb-1 btn-light-danger text-danger btn-lg px-4 fs-4 font-medium"
                        data-bs-toggle="modal"
                        data-bs-target="#with-grid-modal"
                      >
                        With Grid Modal
                      </button>
                            ...
                            <div class="modal-body">
                              <div class="container-fluid">
                                <div class="row border mt-3">
                                  <div
                                    class="col-md-4 border-end bg-light py-3"
                                  >
                                    .col-md-4
                                  </div>
                                ...
                                <div class="row border mt-3">
                                  <div class="col-sm-9 border-end bg-light">
                                    ...
                                    <div class="row border-top">
                                      <div
                                        class="col-8 col-sm-6 py-3 border-end"
                                      >
                      ...
                      <div
                        class="modal fade"
                        id="vertical-center-scroll-modal"
                        tabindex="-1"
                        aria-labelledby="vertical-center-modal"
                        aria-hidden="true"
                      >
                ...
                <div class="card w-100">
                  <div class="card-body">
                    ...
                    <div class="button-group">
                      <button
                        type="button"
                        class="btn mb-1 btn-lg px-4 fs-4 font-medium btn-light-primary text-primary"
                        data-bs-toggle="modal"
                      ...
                      <button
                        type="button"
                        class="btn mb-1 btn-lg px-4 fs-4 font-medium btn-light-success text-success"
                        data-bs-toggle="modal"
                        data-bs-target="#samedata-modal"
                      ...
                      <button
                        type="button"
                        class="btn mb-1 btn-lg px-4 fs-4 font-medium btn-light-warning text-warning"
                        data-bs-toggle="modal"
                        data-bs-target="#samedata-modal"
                          ...
                          <div class="modal-content">
                            <div class="modal-body">
                              ...
                              <form action="#" class="ps-3 pr-3">
                                ...
                                <div class="mb-3 text-center">
                                  <button
                                    class="btn btn-rounded btn-light-info text-info font-medium"
                                    type="submit"
                                  >
                                    Sign In
                                  </button>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="button-group">
                      ...
                      <div
                        class="modal fade"
                        id="bs-fullscreen-down-xl"
                        tabindex="-1"
                        aria-labelledby="bs-example-modal-xl"
                        aria-hidden="true"
                      >
                      ...
                      <div
                        class="modal fade"
                        id="bs-fullscreen-down-xxl"
                        tabindex="-1"
                        aria-labelledby="bs-example-modal-xxl"
                        aria-hidden="true"
                      >
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="button-group">
                      ...
                      <button
                        type="button"
                        class="btn mb-1 btn-light-info text-info btn-lg px-4 fs-4 font-medium"
                        data-bs-toggle="modal"
                      ...
                      >
                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                          <div class="modal-content">
                            <div
                              class="modal-header modal-colored-header bg-info text-white"
                            >
                              <h4
                                class="modal-title"
                        ...
                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <button
                                type="button"
                                class="btn btn-light-warning text-warning font-medium"
                              >
                                Save changes
                              </button>
                            </div>
                        ...
                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <button
                                type="button"
                                class="btn btn-light-success text-success font-medium"
                              >
                                Save changes
                              </button>
                            </div>
                      ...
                      <button
                        type="button"
                        class="btn mb-1 btn-dark btn-lg px-4 fs-4 font-medium"
                        data-bs-toggle="modal"
                      ...
                      >
                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                          <div class="modal-content">
                            <div
                              class="modal-header modal-colored-header bg-dark"
                            >
                              <h4
                  ...
                  <div class="card-body">
                    ...
                    <div class="button-group">
                      ...
                      <button
                        ...
                        class="btn mb-1 btn-light-primary text-primary btn-lg px-4 fs-4 font-medium"
                        data-bs-toggle="modal"
                        data-bs-target="#bg-primary-header-modal"
                      >
                        Primary Modal
                      </button>
                      <!-- Primary Header Modal -->
                      <div
                        id="bg-primary-header-modal"
                        class="modal fade"
                        tabindex="-1"
                        aria-labelledby="primary-header-modalLabel"
                        aria-hidden="true"
                      >
                        <div class="modal-dialog modal-dialog-scrollable modal-lg">
                          <div class="modal-content modal-filled bg-primary">
                            <div
                              class="modal-header modal-colored-header text-white"
                            >
                              <h4
                                class="modal-title"
                                id="primary-header-modalLabel"
                      ...
                      <button
                        ...
                        class="btn mb-1 btn-light-danger text-danger btn-lg px-4 fs-4 font-medium"
                        data-bs-toggle="modal"
                        data-bs-target="#bg-danger-header-modal"
                      >
                        Danger Modal
                      </button>
                      <!-- danger Header Modal -->
                      <div
                        id="bg-danger-header-modal"
                        class="modal fade"
                        tabindex="-1"
                        aria-labelledby="danger-header-modalLabel"
                        aria-hidden="true"
                      ...
                      <button
                        ...
                        class="btn mb-1 btn-light-warning text-warning btn-lg px-4 fs-4 font-medium"
                        data-bs-toggle="modal"
                        data-bs-target="#bg-warning-header-modal"
                      >
                        Warning Modal
                      </button>
                      <!-- warning Header Modal -->
                      <div
                        id="bg-warning-header-modal"
                        class="modal fade"
                        tabindex="-1"
                        aria-labelledby="warning-header-modalLabel"
                        aria-hidden="true"
                      ...
                      <button
                        ...
                        class="btn mb-1 btn-light-success text-success btn-lg px-4 fs-4 font-medium"
                        data-bs-toggle="modal"
                        data-bs-target="#bg-success-header-modal"
                      >
                        Success Modal
                      </button>
                      <!-- success Header Modal -->
                      <div
                        id="bg-success-header-modal"
                        class="modal fade"
                        tabindex="-1"
                        aria-labelledby="success-header-modalLabel"
                        aria-hidden="true"
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="button-group">
                      ...
                      <button
                        type="button"
                        class="btn mb-1 btn-light-success text-success font-medium btn-lg px-4 fs-4 font-medium"
                        data-bs-toggle="modal"
                      ...
                      <button
                        type="button"
                        class="btn mb-1 btn-light-info text-info font-medium btn-lg px-4 fs-4 font-medium"
                        data-bs-toggle="modal"
                      ...
                      <button
                        type="button"
                        class="btn mb-1 btn-light-warning text-warning font-medium btn-lg px-4 fs-4 font-medium"
                        data-bs-toggle="modal"
                      ...
                      <button
                        type="button"
                        class="btn mb-1 btn-light-danger text-danger font-medium btn-lg px-4 fs-4 font-medium"
                        data-bs-toggle="modal"
