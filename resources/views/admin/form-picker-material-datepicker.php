...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-picker-material-datepicker.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:53:43 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
    ...
    <link rel="stylesheet" href="../../dist/libs/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css">
    <!-- --------------------------------------------------- -->
    <!-- Core Css -->
    <!-- --------------------------------------------------- -->
            ...
            <div class="col-12">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <label class="mt-3 font-weight-medium mb-1">Default Material Date Picker</label>
                      <input type="text" class="form-control" placeholder="2023-06-04" id="mdate" />
                      <label class="mt-3 font-weight-medium mb-1">Default Material Date Timepicker</label>
                    ...
                    <div class="col-12">
                      <label class="mt-3 font-weight-medium mb-1">French Locales (Week starts at Monday)</label>
  ...
  <div class="offcanvas offcanvas-end customizer" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" data-simplebar="">
    ...
    <script src="../../dist/libs/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js"></script>
    <script>
...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-picker-material-datepicker.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:53:44 GMT -->
</html>
