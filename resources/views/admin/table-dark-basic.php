...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/table-dark-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:54:01 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
      ...
      <div class="body-wrapper">
        ...
        <div class="container-fluid">
          <!-- --------------------------------------------------- -->
          <!--  Table Dark Basic Start -->
          <!-- --------------------------------------------------- -->
          <div class="card bg-light-info shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
              <div class="row align-items-center">
                <div class="col-9">
                  <h4 class="fw-semibold mb-8">Table Dark Basic</h4>
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item"><a class="text-muted " href="{{ route('index') }}">Dashboard</a></li>
                      <li class="breadcrumb-item" aria-current="page">Table Dark Basic</li>
                    </ol>
                  </nav>
                </div>
                <div class="col-3">
                  ...
                  <div class="card-body">
                    <div class="d-flex mb-1 align-items-center">
                      ...
                      <div class="ms-auto flex-shrink-0">
                        <button
                          class="btn btn-light-primary text-primary rounded-pill  btn-sm"
                          title="View Code"
                    ...
                    <div class="table-responsive">
                      <table class="table border table-dark mb-0">
                        <thead>
                          <!-- start row -->
                          <tr>
                            <th scope="col">#</th>
              ...
              <div class="col-12">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table border table-striped table-dark mb-0">
                        <thead>
                          <!-- start row -->
                          <tr>
                            <th scope="col">#</th>
              ...
              <div class="col-12">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table
                        class="table border table-bordered table-dark mb-0"
                      >
                        <thead>
                          <!-- start row -->
                          <tr>
                ...
                <!-- ---------------------
                                                    end Bordered with Inverse Table
                                                ---------------- -->
              </div>
              <div class="col-12">
                <!-- ---------------------
                                                    start Contextual classes inverse
                                                ---------------- -->
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex mb-1 align-items-center">
                      <div>
                        <h5 class="mb-0">Contextual classes inverse</h5>
                      </div>
                      <div class="ms-auto flex-shrink-0">
                        <button
                          class="btn btn-light-primary text-primary rounded-pill  btn-sm"
                        ...
                        >
                          <div class="modal-dialog modal-dialog-scrollable modal-lg">
                            <div class="modal-content">
                              <div class="modal-header border-bottom">
                                <h5 class="modal-title" id="exampleModalLabel">
                                  Contextual classes inverse - View Code
                                </h5>
                                <button
                                  type="button"
                                  class="btn-close"
                    ...
                    <p class="card-subtitle mb-3">
                      Regular table background variants are not available with
                      the dark table, however, you may use text or background
                      utilities to achieve similar styles.
                    </p>
                    <div class="table-responsive">
                      <table class="table border table-dark mb-0">
                        <thead>
                ...
                <!-- ---------------------
                                                    end Contextual classes inverse
                                                ---------------- -->
              </div>
            </div>
          </section>
          <!-- --------------------------------------------------- -->
          <!--  Table Dark Basic End -->
          <!-- --------------------------------------------------- -->
        </div>
      </div>
