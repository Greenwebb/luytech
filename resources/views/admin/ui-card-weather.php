...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/ui-card-weather.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:55 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
      ...
      <div class="body-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <img class="card-img-top" src="../../dist/images/backgrounds/weather.jpg" alt="Card image cap"
