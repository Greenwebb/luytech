...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-picker-datetimepicker.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:53:37 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
    ...
    <link rel="stylesheet" href="../../dist/libs/pickadate-jalaali/lib/themes/default.css">
    <link rel="stylesheet" href="../../dist/libs/pickadate-jalaali/lib/themes/default.date.css">
    <link rel="stylesheet" href="../../dist/libs/pickadate-jalaali/lib/themes/default.time.css">
    <!-- --------------------------------------------------- -->
    <!-- Core Css -->
    <!-- --------------------------------------------------- -->
          ...
          <div class="card bg-light-info shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8">Picker-Datetimepicker</h4>
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Default Pickadate</label>
                    <h6 class="card-subtitle mb-3">
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Hide/Change Buttons</label>
                    <h6 class="card-subtitle mb-3">
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Select Year</label>
                    <h6 class="card-subtitle mb-3">
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Short string with Pickadate</label>
                    <h6 class="card-subtitle mb-3">
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Change First Week</label>
                    <h6 class="card-subtitle mb-3">
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Date Limits</label>
                    <h6 class="card-subtitle mb-3">
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Change Formats</label>
                    <h6 class="card-subtitle mb-3">
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Language Translation</label>
                    <h6 class="card-subtitle mb-3">
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Change Arrows</label>
                    <h6 class="card-subtitle mb-3">
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Disable arbitrary dates</label>
                    <h6 class="card-subtitle mb-3">
                      To use add
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control pickadate-disable-arbitrarydates"
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Disable days of the week</label>
                    <h6 class="card-subtitle mb-3">
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Selectors Month &amp; Year</label>
                    <h6 class="card-subtitle mb-3">
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Minimum and maximum date range</label>
                    <h6 class="card-subtitle mb-3">
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Dropdown Month &amp; Year</label>
                    <h6 class="card-subtitle mb-3">
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Picker Events</label>
                    <h6 class="card-subtitle mb-3">
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Native calendar of Disable picker</label>
                    <h6 class="card-subtitle mb-3">
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Default Pickatime</label>
                    <h6 class="card-subtitle mb-3">
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Clear Button</label>
                    <h6 class="card-subtitle mb-3">
                      To use add <code>.pickadate-clear-buttons</code> class to
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Minimum and maximum time range</label>
                    <h6 class="card-subtitle mb-3">
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Format of Label</label>
                    <h6 class="card-subtitle mb-3">
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Time Format Display</label>
                    <h6 class="card-subtitle mb-3">
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Current Time Limit</label>
                    <h6 class="card-subtitle mb-3">
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Disable set of Time</label>
                    <h6 class="card-subtitle mb-3">
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Intervals</label>
                    <h6 class="card-subtitle mb-3">
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Disable set of time using Object</label>
                    <h6 class="card-subtitle mb-3">
                      To use add
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Disable set of time using Integers</label>
                    <h6 class="card-subtitle mb-3">
                      To use add
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Disable All with exceptions</label>
                    <h6 class="card-subtitle mb-3">
                  ...
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Close on a user action</label>
                    <h6 class="card-subtitle mb-3">
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Open and Close Calendar</label>
                    <div class="input-group">
                      <button id="api_button_open" class="btn btn btn-primary" type="button">
                        Open
                      </button>
                      <button id="api_button_close" class="btn btn btn-danger" type="button" style="display: none">
                        Close
                      </button>

                      <input autofocus type="text" id="api_picker_open" class="datepicker form-control" type="text" />
                    </div>
                  </div>
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Clear the Date</label>
                    <div class="input-group">
                      <button id="api_button_clear" class="btn btn btn-danger" type="button">
                        Clear date
                      </button>

                      <input id="api_picker_clear" class="datepicker form-control" value="15 October, 2010"
                        data-value="2012-10-15" type="text" />
                    </div>
                  </div>
                  <div class="mb-4">
                    <label class="font-weight-medium mb-1 fs-4 text-dark">Clear the Date With Inline Button</label>
                    <div class="input-group">
                      <input type="text" class="datepicker form-control" id="api_picker_clear_b"
                        value="15 October, 2010" data-value="2012-10-15" />

                      <button class="btn btn-outline-danger input-clear" id="api_button_clear_b" type="button">
                        <i class="ti ti-circle-x-filled fs-5"></i>
                      </button>
                    </div>
                  </div>
                </div>
  ...
  <div class="offcanvas offcanvas-end customizer" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" data-simplebar="">
    ...
    <!-- ---------------------------------------------- -->
    <script src="../../dist/libs/pickadate-jalaali/lib/compressed/picker.js"></script>
    <script src="../../dist/libs/pickadate-jalaali/lib/compressed/picker.date.js"></script>
    <script src="../../dist/libs/pickadate-jalaali/lib/compressed/picker.time.js"></script>
    <script src="../../dist/libs/pickadate-jalaali/lib/compressed/legacy.js"></script>
    <script src="../../dist/libs/bootstrap-material-datetimepicker/node_modules/moment/moment.js"></script>
    <script src="../../dist/libs/daterangepicker/daterangepicker.js"></script>
    <script src="../../dist/js/plugins/datetimepicker.init.js"></script>
  </body>

<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-picker-datetimepicker.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:53:42 GMT -->
</html>
