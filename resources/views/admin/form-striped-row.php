...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-striped-row.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:54:00 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <form class="form-horizontal striped-rows b-form border-top">
                  <div class="card-body">
