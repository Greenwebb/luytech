...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/ui-dropdowns.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:42 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
        ...
        <div class="container-fluid">
          ...
          <div class="card bg-light-info shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
              <div class="row align-items-center">
                <div class="col-9">
                  <h4 class="fw-semibold mb-8">Dropdown</h4>
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item"><a class="text-muted " href="{{ route('index') }}">Dashboard</a></li>
                      <li class="breadcrumb-item" aria-current="page">Dropdown</li>
                    </ol>
                  </nav>
                </div>
                <div class="col-3">
          ...
          <section>
            ...
            <div class="row">
              ...
              <div class="col-lg-6 d-flex align-items-stretch">
                <!-- ---------------------
                                    start Light Button with Dropdown
                                ---------------- -->
                <div class="card w-100">
                  <div class="card-body">
                    <div class="mb-4">
                    ...
                    <div>
                      ...
                      <div class="btn-group mb-2">
                        <button
                          class="btn btn-light-danger text-danger dropdown-toggle"
                          type="button"
                          id="dropdownMenuButton"
                          data-bs-toggle="dropdown"
                          aria-expanded="false"
                      ...
                      <div class="btn-group mb-2">
                        <button
                          class="btn btn-light-info text-info dropdown-toggle"
                          type="button"
                          id="dropdownMenuButton"
                          data-bs-toggle="dropdown"
                          aria-expanded="false"
                      ...
                      <div class="btn-group mb-2">
                        <button
                          class="btn btn-light-warning text-warning dropdown-toggle"
                          type="button"
                          id="dropdownMenuButton"
                          data-bs-toggle="dropdown"
                          aria-expanded="false"
                      ...
                      <div class="btn-group mb-2">
                        <button
                          class="btn btn-light-success text-success dropdown-toggle"
                          type="button"
                          id="dropdownMenuButton"
                          data-bs-toggle="dropdown"
                          aria-expanded="false"
                ...
                <!-- ---------------------
                                    end Light Button with Dropdown
                                ---------------- -->
              </div>
              ...
              <div class="col-lg-6 d-flex align-items-stretch">
                <!-- ---------------------
                                    start Light Split button dropdowns
                                ---------------- -->
                <div class="card w-100">
                  <div class="card-body">
                    <div class="mb-4">
                    ...
                    <div class="btn-group mb-2">
                      ...
                      <button
                        type="button"
                        class="btn btn-light-danger text-danger dropdown-toggle dropdown-toggle-split"
                        data-bs-toggle="dropdown"
                        aria-haspopup="true"
                        aria-expanded="false"
                      >
                    ...
                    <div class="btn-group mb-2">
                      ...
                      <button
                        type="button"
                        class="btn btn-light-primary text-primary dropdown-toggle dropdown-toggle-split"
                        data-bs-toggle="dropdown"
                        aria-haspopup="true"
                        aria-expanded="false"
                      >
                    ...
                    <div class="btn-group mb-2">
                      ...
                      <button
                        type="button"
                        class="btn btn-light-warning text-warning dropdown-toggle dropdown-toggle-split"
                        data-bs-toggle="dropdown"
                        aria-haspopup="true"
                        aria-expanded="false"
                      >
                    ...
                    <div class="btn-group mb-2">
                      ...
                      <button
                        type="button"
                        class="btn btn-light-success text-success dropdown-toggle dropdown-toggle-split"
                        data-bs-toggle="dropdown"
                        aria-haspopup="true"
                        aria-expanded="false"
                      >
                    ...
                    <div class="btn-group mb-2">
                      ...
                      <button
                        type="button"
                        class="btn btn-light-info text-info dropdown-toggle dropdown-toggle-split"
                        data-bs-toggle="dropdown"
                        aria-haspopup="true"
                        aria-expanded="false"
                      >
                ...
                <!-- ---------------------
                                    end Light Split button dropdowns
                                ---------------- -->
              </div>
                ...
                <div class="card w-100">
                  <div class="card-body">
                    ...
                    <div class="button-group">
                      <div class="btn-group">
                        <button
                          class="btn btn-light-secondary text-secondary font-medium btn-lg dropdown-toggle"
                          type="button"
                          data-bs-toggle="dropdown"
                          aria-haspopup="true"
                          aria-expanded="false"
                      ...
                      <div class="btn-group">
                        <button
                          class="btn btn-light-secondary text-secondary font-medium btn-lg me-0"
                          type="button"
                          data-bs-toggle="dropdown"
                          aria-haspopup="true"
                          aria-expanded="false"
                        ...
                        <button
                          type="button"
                          class="btn btn-lg btn-light-secondary text-secondary font-medium dropdown-toggle dropdown-toggle-split"
                          data-bs-toggle="dropdown"
                          aria-haspopup="true"
                          aria-expanded="false"
                        >
              ...
              <div class="col-lg-6 d-flex align-items-stretch">
                ...
                <div class="card w-100">
                  <div class="card-body">
                    ...
                    <div class="btn-group">
                      <button
                        class="btn btn-light-secondary text-secondary font-medium btn-sm"
                        type="button"
                        data-bs-toggle="dropdown"
                        aria-haspopup="true"
                        aria-expanded="false"
                      ...
                      <button
                        type="button"
                        class="btn btn-sm btn-light-secondary text-secondary font-medium dropdown-toggle dropdown-toggle-split"
                        data-bs-toggle="dropdown"
                        aria-haspopup="true"
                        aria-expanded="false"
                      >
                ...
                <div class="card w-100">
                  <div class="card-body">
                    ...
                    <div class="button-group">
                      <div class="btn-group">
                        <button
                          class="btn btn-light-secondary text-secondary btn-lg dropdown-toggle"
                          type="button"
                          data-bs-toggle="dropdown"
                          aria-haspopup="true"
                          aria-expanded="false"
                      ...
                      <div class="btn-group">
                        <button
                          class="me-0 btn btn-light-secondary text-secondary btn-lg"
                          type="button"
                          data-bs-toggle="dropdown"
                          aria-haspopup="true"
                          aria-expanded="false"
                        ...
                        <button
                          type="button"
                          class="btn btn-lg btn-light-secondary text-secondary dropdown-toggle dropdown-toggle-split"
                          data-bs-toggle="dropdown"
                          aria-haspopup="true"
                          aria-expanded="false"
                        >
              ...
              <div class="col-lg-6 d-flex align-items-stretch">
                ...
                <div class="card w-100">
                  <div class="card-body">
                    ...
                    <div class="btn-group">
                      <button
                        class="btn btn-light-secondary text-secondary btn-sm dropdown-toggle"
                        type="button"
                        data-bs-toggle="dropdown"
                        aria-haspopup="true"
                        aria-expanded="false"
                    ...
                    <div class="btn-group">
                      <button
                        class="btn btn-light-secondary text-secondary btn-sm"
                        type="button"
                        data-bs-toggle="dropdown"
                        aria-haspopup="true"
                        aria-expanded="false"
                      ...
                      <button
                        type="button"
                        class="btn btn-sm btn-light-secondary text-secondary dropdown-toggle dropdown-toggle-split"
                        data-bs-toggle="dropdown"
                        aria-haspopup="true"
                        aria-expanded="false"
                      >
              ...
              <div class="col-lg-6 d-flex align-items-stretch">
                <!-- ---------------------
                                    start Light Animated Dropdowns
                                ---------------- -->
                <div class="card w-100">
                  <div class="card-body">
                    <div class="mb-4">
              ...
              <div class="col-lg-6 d-flex align-items-stretch">
                <!-- ---------------------
                                    start Animated Dropdowns with icon
                                ---------------- -->
                <div class="card w-100">
                  <div class="card-body">
                    <div class="mb-4">
                ...
                <!-- ---------------------
                                    end Animated Dropdowns with icon
                                ---------------- -->
              </div>
              ...
              <div class="col-lg-6 d-flex align-items-stretch">
                <!-- ---------------------
                                    start Light Animated Button Dropdowns with icon
                                ---------------- -->
                <div class="card w-100">
                  <div class="card-body">
                    <div class="mb-4">
                ...
                <!-- ---------------------
                                    end Light Animated Button Dropdowns with icon
                                ---------------- -->
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <!-- ---------------------
                                    start Direction of the Dropdown
                                ---------------- -->
                <div class="card">
                  <div class="card-body">
                    <div class="mb-4">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <h5 class="card-title">Dropdowm Right Side</h5>
                  ...
                  <div class="card-body">
                    ...
                    <div class="button-group">
                      ...
                      <div class="btn-group">
                        <button
                          type="button"
                          class="me-0 btn btn-light-secondary text-secondary dropdown-toggle"
                          data-bs-toggle="dropdown"
                          aria-haspopup="true"
                          aria-expanded="false"
                        >
