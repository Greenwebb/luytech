...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-repeater.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:54:00 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
            ...
            <div class="col-12">
              <div class="card">
                <div class="border-bottom title-part-padding">
                  <h4 class="card-title mb-0">Full Form Repeater</h4>
                </div>
                <div class="card-body">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <form class="row">
                    ...
                    <div class="col-sm-2">
                      <div class="mb-3">
                        <button onclick="education_fields();" class="
                            btn
                            btn-success
                            font-weight-medium
                            waves-effect waves-light
  ...
  <div class="offcanvas offcanvas-end customizer" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" data-simplebar="">
    ...
    <!-- ---------------------------------------------- -->
    <script src="../../dist/libs/jquery.repeater/jquery.repeater.min.js"></script>
    <script src="../../dist/js/plugins/repeater-init.js"></script>
  </body>

<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-repeater.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:54:01 GMT -->
</html>
