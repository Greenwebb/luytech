...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/widgets-banners.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:30 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
          ...
          <div class="row">
            <div class="col-lg-8">
                  ...
                  <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-sm-5">
                      <div class="position-relative mb-n5 text-center">
                        <img src="../../dist/images/backgrounds/track-bg.png" alt="" class="img-fluid" style="width: 180px; height: 230px;">
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="card">
                    <div class="card-body text-center">
                      <img src="../../dist/images/products/empty-shopping-bag.gif" alt="" class="img-fluid mb-4" width="200">
            ...
            <div class="col-lg-4">
              <div class="card">
                <div class="card-body text-center">
                  <p>LEVEL UP</p>
                  <img src="../../dist/images/backgrounds/gold.png" alt="" class="img-fluid mb-4" width="150">
              ...
              <div class="card">
                <div class="card-body text-center">
                  ...
                  <div class="position-relative overflow-hidden d-inline-block">
                    <img src="../../dist/images/profile/user-1.jpg" alt="" class="img-fluid mb-4 rounded-circle position-relative" width="140">
                    <span class="badge rounded-pill bg-danger fs-2 position-absolute top-0 end-0 d-flex align-items-center justify-content-center me-3 mt-2" style="width: 20px; height: 20px;">1</span>
                  </div>
...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/widgets-banners.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:32 GMT -->
</html>