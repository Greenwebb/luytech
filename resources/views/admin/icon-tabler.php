...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/icon-tabler.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:54:31 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
        ...
        <div class="container-fluid">
          ...
          <div class="card w-100 h-100 position-relative overflow-hidden">
            <div class="card-body p-0">
              <iframe src="https://tabler-icons.io/" frameborder="0" style="height: calc(100vh - 280px); width: 100%;" data-simplebar=""></iframe>
            </div>
          </div>
          <!-- --------------------------------------------------- -->
          <!--  Icon tabler End -->
