...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/component-sweetalert.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:56 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
          ...
          <div class="row">
            <div class="col-sm-6 col-lg-3">
              <div class="card">
                ...
                <div class="card-body p-3">
                  <img src="../../dist/images/alert/alert.png" alt="alert" class="img-fluid model_img"
                    id="sa-basic" />
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-lg-3">
              <div class="card">
                ...
                <div class="card-body p-3">
                  <img src="../../dist/images/alert/alert2.png" alt="alert" class="img-fluid model_img"
                    id="sa-title" />
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="card">
                ...
                <div class="card-body p-3">
                  <img src="../../dist/images/alert/alert3.png" alt="alert" class="img-fluid model_img"
                    id="sa-success" />
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-lg-3">
              <div class="card">
                ...
                <div class="card-body p-3">
                  <img src="../../dist/images/alert/alert4.png" alt="alert" class="img-fluid model_img"
                    id="sa-warning" />
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="card">
                ...
                <div class="card-body p-3">
                  <img src="../../dist/images/alert/alert7.png" alt="alert" class="img-fluid model_img"
                    id="sa-animation" />
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-lg-3">
              <div class="card">
                ...
                <div class="card-body p-3">
                  <img src="../../dist/images/alert/model.png" alt="alert" class="img-fluid model_img"
                    id="sa-confirm" />
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-lg-3">
              <div class="card">
                ...
                <div class="card-body p-3">
                  <img src="../../dist/images/alert/alert6.png" alt="alert" class="img-fluid model_img"
                    id="sa-passparameter" />
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="card">
                ...
                <div class="card-body p-3">
                  <img src="../../dist/images/alert/model.png" alt="alert" class="img-fluid model_img" id="sa-bg" />
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-lg-3">
...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/component-sweetalert.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:53:06 GMT -->
</html>
