...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/table-jsgrid.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:54:10 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
    ...
    <link rel="stylesheet" href="../../assets/extra-libs/jsgrid/jsgrid.min.css">
    <link rel="stylesheet" href="../../assets/extra-libs/jsgrid/jsgrid-theme.min.css">
    <!-- --------------------------------------------------- -->
    <!-- Core Css -->
    <!-- --------------------------------------------------- -->
          ...
          <div class="card bg-light-info shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8">Table-Jsgrid</h4>
            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="border-bottom title-part-padding">
                  <h4 class="card-title mb-0">Editable with Datatable</h4>
                </div>
                <div class="card-body">
              ...
              <div class="card">
                <div class="border-bottom title-part-padding">
                  <h4 class="card-title mb-0">Static</h4>
                </div>
                <div class="card-body">
              ...
              <div class="card">
                <div class="border-bottom title-part-padding">
                  <h4 class="card-title mb-0">Shorting</h4>
                </div>
                <div class="card-body">
                  <div class="col-md-2 row">
                    <select
                      id="sortingField"
                      class="custom-select form-control input-sm mb-2"
                    >
                      <option>Name</option>
                      <option>Age</option>
  ...
  <div class="offcanvas offcanvas-end customizer" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" data-simplebar="">
    ...
    <!-- ---------------------------------------------- -->
    <script src="../../assets/extra-libs/jsgrid/db.js"></script>
    <script src="../../assets/extra-libs/jsgrid/jsgrid.min.js"></script>
    <script src="../../dist/js/plugins/jsgrid-init.js"></script>
  </body>

<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/table-jsgrid.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:54:14 GMT -->
</html>
