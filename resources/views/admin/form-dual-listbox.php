...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-dual-listbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:53:19 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
    ...
    <!-- Dual Light Box -->
    <!-- --------------------------------------------------- -->
    <link rel="stylesheet" href="../../dist/libs/bootstrap-duallistbox/dist/bootstrap-duallistbox.min.css">
                    ...
                    <p class="card-subtitle mb-3">
                      ...
                      <mark
                        ><code
                          ...
                          infoTextFiltered, infoTextEmpty</code
                        ></mark
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <select
                      multiple="multiple"
                      size="10"
                      class="duallistbox-custom-height"
                    >
                      <option value="1">Amsterdam</option>
                      <option value="2">Antwerp</option>
                      <option value="3" selected="selected">Athens</option>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="buttons block mt-3">
                      <button
                        type="button"
                        class="btn btn-light-info text-info rounded-pill font-medium duallistbox-add"
                      >
                        Add options
                      </button>
                      <button
                        type="button"
                        class="btn btn-light-info text-info rounded-pill font-medium duallistbox-add-clear"
                      >
  ...
  <div class="offcanvas offcanvas-end customizer" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" data-simplebar="">
    ...
    <!-- ---------------------------------------------- -->
    <script src="../../dist/libs/bootstrap-duallistbox/dist/jquery.bootstrap-duallistbox.min.js"></script>
    <script src="../../dist/js/forms/dual-listbox.js"></script>
  </body>

<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-dual-listbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:53:21 GMT -->
</html>
