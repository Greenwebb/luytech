...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/ui-buttons.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:41 GMT -->
<head>
  <!-- --------------------------------------------------- -->
  <!-- Title -->
  <!-- --------------------------------------------------- -->
    ...
    <div class="body-wrapper">
                  ...
                  <div class="col-4 ms-n4">
                    <div class="position-relative p-7 border-start h-100">
                      ...
                      <ul class="">
                        ...
                        <li class="mb-3">
                          <a class="fw-semibold text-dark bg-hover-primary    " href="authentication-error.php">404 Error
                            Page</a>
                        </li>
                        <li class="mb-3">
                        ...
                        <li class="mb-3">
                          <a class="fw-semibold text-dark bg-hover-primary    " href="page-user-profile.php">User
                            Application</a>
                        </li>
                        <li class="mb-3">
                          <a class="fw-semibold text-dark bg-hover-primary    " href="page-account-settings.php">Account
                            Settings</a>
                        </li>
                      </ul>
                    </div>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="button-group">
                  ...
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-secondary">
                    Secondary
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-success">
                    Success
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-info">
                    Info
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-warning">
                    Warning
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-danger">
                    Danger
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-light">
                    Light
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-dark">
                    Dark
                  </button>
                </div>
              </div>
          ...
          <div class="col-lg-12 col-xl-6">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="button-group">
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-light-primary text-primary">
                    Primary
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-light-secondary text-secondary">
                    Secondary
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-light-success text-success">
                    Success
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-light-info text-info">
                    Info
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-light-warning text-warning">
                    Warning
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-light-danger text-danger">
                    Danger
                  </button>
                </div>
              </div>
          ...
          <div class="col-lg-12 col-xl-6">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="button-group">
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-outline-primary">
                    Primary
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-outline-secondary">
                    Secondary
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-outline-success">
                    Success
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-outline-info">
                    Info
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-outline-warning">
                    Warning
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-outline-danger">
                    Danger
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-outline-light">
                    Light
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-outline-dark">
                    Dark
                  </button>
                </div>
              </div>
          ...
          <div class="col-lg-12 col-xl-6">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="button-group">
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-rounded btn-primary">
                    Primary
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-rounded btn-secondary">
                    Secondary
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-rounded btn-success">
                    Success
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-rounded btn-info">
                    Info
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-rounded btn-warning">
                    Warning
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-rounded btn-danger">
                    Danger
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-rounded btn-light">
                    Light
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-rounded btn-dark">
                    Dark
                  </button>
                </div>
              </div>
          ...
          <div class="col-lg-12 col-xl-6">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <p class="mb-3 card-subtitle">
                  Use a classes
                  <mark><code>btn btn-rounded btn-light-success</code></mark>
                ...
                <div class="button-group">
                  ...
                  <button type="button"
                    class="btn mb-1 waves-effect waves-light btn-rounded btn-light-secondary text-secondary">
                    Secondary
                  </button>
                  <button type="button"
                    class="btn mb-1 waves-effect waves-light btn-rounded btn-light-success text-success">
                    Success
                  </button>
                  <button type="button" class="btn waves-effect waves-light btn-rounded btn-light-info text-info">
                    Info
                  </button>
                  <button type="button"
                    class="btn mb-1 waves-effect waves-light btn-rounded btn-light-warning text-warning">
                    Warning
                  </button>
          ...
          <div class="col-lg-12">
            <!-- ---------------------
                                                  start Rounded outlined Buttons
                                              ---------------- -->
            <div class="card">
              <div class="card-body">
                <div class="mb-4">
                ...
                <div class="button-group">
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-rounded btn-outline-primary">
                    Primary
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-rounded btn-outline-secondary">
                    Secondary
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-rounded btn-outline-success">
                    Success
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-rounded btn-outline-info">
                    Info
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-rounded btn-outline-warning">
                    Warning
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-rounded btn-outline-danger">
                    Danger
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-rounded btn-outline-light">
                    Light
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-rounded btn-outline-dark">
                    Dark
                  </button>
                </div>
              </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="button-group">
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-lg btn-primary">
                    Large .btn-lg
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-primary">
                    Normal .btn
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-sm btn-primary">
                    Small .btn-sm
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-xs btn-primary">
                    Tiny .btn-xs
                  </button>
                </div>
              </div>
          ...
          <div class="col-lg-6">
            <!-- ---------------------
                                                  start Button Sizes with rounded
                                              ---------------- -->
            <div class="card">
              <div class="card-body">
                <div class="mb-4">
                ...
                <div class="button-group">
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-lg btn-rounded btn-primary">
                    Large .btn-lg
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-rounded btn-primary">
                    Normal .btn
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-rounded btn-sm btn-primary">
                    Small .btn-sm
                  </button>
                  <button type="button" class="btn mb-1 waves-effect waves-light btn-rounded btn-xs btn-primary">
                    Tiny .btn-xs
                  </button>
                </div>
              </div>
        ...
        <div class="row">
            ...
            <div class="card w-100">
              <div class="card-body">
                ...
                <div class="row justify-content-center">
                  <div class="col-md-12 d-grid gap-2">
                    <button type="button"
                      class="btn waves-effect waves-light btn-light-primary text-primary font-medium">
                      Primary
                    </button>
                    <button type="button"
                      class="btn waves-effect waves-light btn-light-secondary text-secondary font-medium">
                      Secondary
                    </button>
                  </div>
                </div>
            ...
            <div class="card w-100">
              <div class="card-body">
                ...
                <div class="row justify-content-center">
                  <div class="col-md-12 d-grid gap-2">
                    <button type="button"
                      class="btn rounded-pill waves-effect waves-light btn-light-primary text-primary font-medium">
                      Primary
                    </button>
                    <button type="button"
                      class="btn rounded-pill waves-effect waves-light btn-light-secondary text-secondary font-medium">
                      Secondary
                    </button>
                  </div>
                </div>
          ...
          <div class="col-lg-6 col-xl-3 d-flex align-items-stretch">
            <!-- ---------------------
                                                  start Rounded outline Block buttons
                                              ---------------- -->
            <div class="card w-100">
              <div class="card-body">
                <div class="mb-4">
            ...
            <!-- ---------------------
                                                  end Rounded outline Block buttons
                                              ---------------- -->
          </div>
          <!-- ------------------------------------------------ -->
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <!-- ---------------------
                                                  start Rounded Button with icon
                                              ---------------- -->
            <div class="card w-100">
              <div class="card-body">
                <div class="mb-4">
            ...
            <!-- ---------------------
                                                  end Rounded Button with icon
                                              ---------------- -->
          </div>
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <!-- ---------------------
                                                  start Outline Button with icon
                                              ---------------- -->
            <div class="card w-100">
              <div class="card-body">
                <div class="mb-4">
            ...
            <!-- ---------------------
                                                  end Outline Button with icon
                                              ---------------- -->
          </div>
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <!-- ---------------------
                                                  start Rounded Outline Button with icon
                                              ---------------- -->
            <div class="card w-100">
              <div class="card-body">
                <div class="mb-4">
            ...
            <!-- ---------------------
                                                  end Rounded Outline Button with icon
                                              ---------------- -->
          </div>
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <!-- ---------------------
                                                  start Light Button with icon
                                              ---------------- -->
            <div class="card w-100">
              <div class="card-body">
                <div class="mb-4">
                ...
                <div class="row button-group">
                  <div class="col-lg-6">
                    <button type="button"
                      class="justify-content-center w-100 btn mb-1 btn-light-primary text-primary font-medium d-flex align-items-center">
                      <i class="ti ti-bell fs-4 me-2"></i>
                      Alert
                    </button>
                    <button type="button"
                      class="justify-content-center w-100 btn mb-1 btn-light-secondary text-secondary font-medium d-flex align-items-center">
                      <i class="ti ti-bell fs-4 me-2"></i>
                      Alert
                    </button>
                    <button type="button"
                      class="justify-content-center w-100 btn mb-1 btn-light-success text-success font-medium d-flex align-items-center">
                      <i class="ti ti-bell fs-4 me-2"></i>
                      Alert
                    </button>
                    <button type="button"
                      class="justify-content-center w-100 btn mb-1 btn-light-info text-info font-medium d-flex align-items-center">
                      <i class="ti ti-bell fs-4 me-2"></i>
                      Alert
                    </button>
                  </div>
                  <div class="col-lg-6">
                    <button type="button"
                      class="justify-content-center w-100 btn mb-1 btn-light-warning text-warning font-medium d-flex align-items-center">
                      <i class="ti ti-bell fs-4 me-2"></i>
                      Alert
                    </button>
                    <button type="button"
                      class="justify-content-center w-100 btn mb-1 btn-light-danger text-danger font-medium d-flex align-items-center">
                      <i class="ti ti-bell fs-4 me-2"></i>
                      Alert
                    </button>
                    <button type="button"
                      class="justify-content-center w-100 btn mb-1 btn-light text-dark font-medium d-flex text-dark align-items-center">
                      <i class="ti ti-bell fs-4 me-2"></i>
                      Alert
                    </button>
                    <button type="button"
            ...
            <!-- ---------------------
                                                  end Light Button with icon
                                              ---------------- -->
          </div>
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <!-- ---------------------
                                                  start Rounded Light Button with icon
                                              ---------------- -->
            <div class="card w-100">
              <div class="card-body">
                <div class="mb-4">
                ...
                <div class="row button-group">
                  <div class="col-lg-6">
                    <button type="button"
                      class="justify-content-center w-100 btn mb-1 btn-rounded btn-light-primary text-primary font-medium d-flex align-items-center">
                      <i class="ti ti-clock-hour-4 fs-4 me-2"></i>
                      Time
                    </button>
                    <button type="button"
                      class="justify-content-center w-100 btn mb-1 btn-rounded btn-light-secondary text-secondary font-medium d-flex align-items-center">
                      <i class="ti ti-clock-hour-4 fs-4 me-2"></i>
                      Time
                    </button>
                    <button type="button"
                      class="justify-content-center w-100 btn mb-1 btn-rounded btn-light-success text-success font-medium d-flex align-items-center">
                      <i class="ti ti-clock-hour-4 fs-4 me-2"></i>
                      Time
                    </button>
                    <button type="button"
                      class="justify-content-center w-100 btn mb-1 btn-rounded btn-light-info text-info font-medium d-flex align-items-center">
                      <i class="ti ti-clock-hour-4 fs-4 me-2"></i>
                      Time
                    </button>
                  </div>
                  <div class="col-lg-6">
                    <button type="button"
                      class="justify-content-center w-100 btn mb-1 btn-rounded btn-light-warning text-warning font-medium d-flex align-items-center">
                      <i class="ti ti-clock-hour-4 fs-4 me-2"></i>
                      Time
                    </button>
                    <button type="button"
                      class="justify-content-center w-100 btn mb-1 btn-rounded btn-light-danger text-danger font-medium d-flex align-items-center">
                      <i class="ti ti-clock-hour-4 fs-4 me-2"></i>
                      Time
                    </button>
                    <button type="button"
                      class="justify-content-center w-100 btn mb-1 btn-rounded btn-light text-dark font-medium d-flex text-dark align-items-center">
                      <i class="ti ti-clock-hour-4 fs-4 me-2"></i>
                      Time
                    </button>
                    <button type="button"
            ...
            <!-- ---------------------
                                                  end Rounded Light Button with icon
                                              ---------------- -->
          </div>
        </div>
        <!-- End row -->
          ...
          <div class="col-lg-6 d-flex align-items-stretch">
            ...
            <div class="card w-100">
              <div class="card-body">
                ...
                <div class="button-group">
                  <button type="button"
                    class="btn mb-1 btn-secondary btn-circle btn-sm d-inline-flex align-items-center justify-content-center">
                    <i class="fs-5 ti ti-heart"></i>
                  </button>
                  <button type="button"
                    class="btn mb-1 btn-primary btn-circle btn-sm d-inline-flex align-items-center justify-content-center">
                    <i class="fs-5 ti ti-heart"></i>
                  </button>
                  <button type="button"
                  ...
                  <button type="button"
                    class="btn mb-1 btn-info btn-circle btn-sm d-inline-flex align-items-center justify-content-center">
                    <i class="fs-5 ti ti-heart"></i>
                  </button>
                  <button type="button"
                    class="btn mb-1 btn-warning btn-circle btn-sm d-inline-flex align-items-center justify-content-center">
                    <i class="fs-5 ti ti-heart"></i>
                  </button>
                  <button type="button"
                ...
                <div class="button-group">
                  <button type="button"
                    class="btn mb-1 btn-light-secondary btn-circle btn-sm d-inline-flex align-items-center justify-content-center">
                    <i class="fs-5 ti ti-heart text-secondary"></i>
                  </button>
                  <button type="button"
                    class="btn mb-1 btn-light-primary btn-circle btn-sm d-inline-flex align-items-center justify-content-center">
                    <i class="fs-5 ti ti-heart text-primary"></i>
                  </button>
                  <button type="button"
                    class="btn mb-1 btn-light-success btn-circle btn-sm d-inline-flex align-items-center justify-content-center">
                    <i class="fs-5 ti ti-heart text-success"></i>
                  </button>
                  <button type="button"
                    class="btn mb-1 btn-light-info btn-circle btn-sm d-inline-flex align-items-center justify-content-center">
                    <i class="fs-5 ti ti-heart text-info"></i>
                  </button>
                  <button type="button"
                    class="btn mb-1 btn-light-warning btn-circle btn-sm d-inline-flex align-items-center justify-content-center">
                    <i class="fs-5 ti ti-heart text-warning"></i>
                  </button>
                  <button type="button"
                    class="btn mb-1 btn-light-danger btn-circle btn-sm d-inline-flex align-items-center justify-content-center">
          ...
          <div class="col-lg-6 d-flex align-items-stretch">
            ...
            <div class="card w-100">
              <div class="card-body">
                ...
                <div class="button-group">
                  <button type="button" class="btn mb-1 btn-secondary btn-circle">
                    <i class="fs-5 ti ti-heart"></i>
                  </button>
                  <button type="button" class="btn mb-1 btn-primary btn-circle">
                    <i class="fs-5 ti ti-heart"></i>
                  </button>
                  <button type="button" class="btn mb-1 btn-success btn-circle">
                    <i class="fs-5 ti ti-heart"></i>
                  </button>
                  <button type="button" class="btn mb-1 btn-info btn-circle">
                    <i class="fs-5 ti ti-heart"></i>
                  </button>
                  <button type="button" class="btn mb-1 btn-warning btn-circle">
                    <i class="fs-5 ti ti-heart"></i>
                  </button>
                  <button type="button" class="btn mb-1 btn-danger btn-circle">
                    <i class="fs-5 ti ti-heart"></i>
                  </button>
                </div>
                ...
                <div class="button-group">
                  <button type="button" class="btn btn-light-secondary btn-circle">
                    <i class="fs-5 ti ti-heart text-secondary"></i>
                  </button>
                  <button type="button" class="btn btn-light-primary btn-circle">
                    <i class="fs-5 ti ti-heart text-primary"></i>
                  </button>
                  <button type="button" class="btn btn-light-success btn-circle">
                    <i class="fs-5 ti ti-heart text-success"></i>
                  </button>
                  <button type="button" class="btn btn-light-info btn-circle">
                    <i class="fs-5 ti ti-heart text-info"></i>
                  </button>
                  <button type="button" class="btn btn-light-warning btn-circle">
                    <i class="fs-5 ti ti-heart text-warning"></i>
                  </button>
          ...
          <div class="col-lg-6 d-flex align-items-stretch">
            ...
            <div class="card w-100">
              <div class="card-body">
                ...
                <div class="button-group">
                  <button type="button"
                    class="d-inline-flex align-items-center justify-content-center btn btn-secondary btn-circle btn-lg">
                    <i class="fs-5 ti ti-file-description"></i>
                  </button>
                  <button type="button"
                    class="d-inline-flex align-items-center justify-content-center btn btn-primary btn-circle btn-lg">
                    <i class="fs-5 ti ti-file-description"></i>
                  </button>
                  <button type="button"
                    class="d-inline-flex align-items-center justify-content-center btn btn-success btn-circle btn-lg">
                    <i class="fs-5 ti ti-file-description"></i>
                  </button>
                  <button type="button"
                  ...
                  <button type="button"
                    class="d-inline-flex align-items-center justify-content-center btn btn-warning btn-circle btn-lg">
                    <i class="fs-5 ti ti-file-description"></i>
                  </button>
                  <button type="button"
                    class="d-inline-flex align-items-center justify-content-center btn btn-danger btn-circle btn-lg">
                    <i class="fs-5 ti ti-file-description"></i>
                  </button>
                </div>
                ...
                <div class="button-group">
                  <button type="button" class="btn btn-light-secondary btn-circle btn-lg">
                    <i class="ti ti-file-text fs-4 text-secondary"></i>
                  </button>
                  <button type="button" class="btn btn-light-primary btn-circle btn-lg">
                    <i class="ti ti-file-text fs-4 text-primary"></i>
                  </button>
                  <button type="button" class="btn btn-light-success btn-circle btn-lg">
                    <i class="ti ti-file-text fs-4 text-success"></i>
                  </button>
                  <button type="button" class="btn btn-light-info btn-circle btn-lg">
                    <i class="ti ti-file-text fs-4 text-info"></i>
                  </button>
                  <button type="button" class="btn btn-light-warning btn-circle btn-lg">
                    <i class="ti ti-file-text fs-4 text-warning"></i>
                  </button>
                  <button type="button" class="btn btn-light-danger btn-circle btn-lg">
            ...
            <!-- ---------------------
                                                  end Circle Large buttons
                                              ---------------- -->
          </div>
          <div class="col-lg-6 d-flex align-items-stretch">
            <!-- ---------------------
                                                  start Circle Extra Large buttons
                                              ---------------- -->
            <div class="card w-100">
              <div class="card-body">
                <div class="mb-4">
                ...
                <div>
                  ...
                  <button type="button" class="btn btn-primary btn-circle btn-xl me-1 mb-1">
                    <i class="ti ti-folder fs-5"></i>
                  </button>
                  <button type="button" class="btn btn-success btn-circle btn-xl me-1 mb-1">
                    <i class="ti ti-folder fs-5"></i>
                  </button>
                  <button type="button" class="btn btn-info btn-circle btn-xl me-1 mb-1">
                    <i class="ti ti-folder fs-5"></i>
                  </button>
                  <button type="button" class="btn btn-warning btn-circle btn-xl me-1 mb-1">
                    <i class="ti ti-folder fs-5"></i>
                  </button>
                  <button type="button" class="btn btn-danger btn-circle btn-xl me-1 mb-1">
                    <i class="ti ti-folder fs-5"></i>
                  </button>
                </div>
                ...
                <div>
                  <button type="button" class="btn btn-light-secondary btn-circle btn-xl me-1 mb-1">
                    <i class="ti ti-folder fs-4 text-secondary"></i>
                  </button>
                  <button type="button" class="btn btn-light-primary btn-circle btn-xl me-1 mb-1">
                    <i class="ti ti-folder fs-4 text-primary"></i>
                  </button>
                  <button type="button" class="btn btn-light-success btn-circle btn-xl me-1 mb-1">
                    <i class="ti ti-folder fs-4 text-success"></i>
                  </button>
                  <button type="button" class="btn btn-light-info btn-circle btn-xl me-1 mb-1">
                    <i class="ti ti-folder fs-4 text-info"></i>
                  </button>
                  <button type="button" class="btn btn-light-warning btn-circle btn-xl me-1 mb-1">
                    <i class="ti ti-folder fs-4 text-warning"></i>
                  </button>
                  <button type="button" class="btn btn-light-danger btn-circle btn-xl me-1 mb-1">
                    <i class="ti ti-folder fs-4 text-danger"></i>
                  </button>
                </div>
              </div>
            </div>
            <!-- ---------------------
                                                  end Circle Extra Large buttons
                                              ---------------- -->
          </div>
        </div>
        <!-- End Row -->
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-xl-4 d-flex align-items-stretch">
            ...
            <div class="card w-100">
              <div class="card-body">
                ...
                <div class="btn-group mb-2" role="group" aria-label="Basic example">
                  <button type="button" class="btn btn-light-secondary text-secondary font-medium">
                ...
                <div class="btn-group mb-2" role="group" aria-label="Basic example">
                  <button type="button" class="btn btn-light-success text-success">
          ...
          <div class="col-lg-6 col-xl-4 d-flex align-items-stretch">
            <!-- ---------------------
                                                  start Button toolbar pagination
                                              ---------------- -->
            <div class="card w-100">
              <div class="card-body">
                <div class="mb-4">
                ...
                <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                  <div class="btn-group me-2 mb-2" role="group" aria-label="First group">
                    <button type="button" class="btn btn-light-info text-info font-medium disabled">
                      1
                    </button>
                    <button type="button" class="btn btn-info">2</button>
                    <button type="button" class="btn btn-light-info text-info font-medium">
                      3
                    </button>
                    <button type="button" class="btn btn-light-info text-info font-medium">
                      4
          ...
          <div class="col-lg-6 col-xl-4 d-flex align-items-stretch">
            <!-- ---------------------
                                                  start Button Toolbar with Input Group
                                              ---------------- -->
            <div class="card w-100">
              <div class="card-body">
                <div class="mb-4">
                ...
                <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                  ...
                  <div class="input-group mt-2 mt-md-0">
                    ...
                    <input type="text" class="form-control" placeholder="Subscribe Now" aria-label="Input group example"
            ...
            <!-- ---------------------
                                                  end Button Toolbar with Input Group
                                              ---------------- -->
          </div>
          ...
          <div class="col-lg-6 col-xl-4 d-flex align-items-stretch">
            <!-- ---------------------
                                                  start Button Toolbar with Jutify Content Input Group
                                              ---------------- -->
            <div class="card w-100">
              <div class="card-body">
                <div class="mb-4">
            ...
            <!-- ---------------------
                                                  end Button Toolbar with Jutify Content Input Group
                                              ---------------- -->
          </div>
          ...
          <div class="col-lg-6 col-xl-4 d-flex align-items-stretch">
            ...
            <div class="card w-100">
              <div class="card-body">
                ...
                <div>
                  <button type="button" class="btn btn-light-success text-success font-medium mb-2"
                  ...
                  <button type="button" class="btn btn-light-info text-info mb-2" data-bs-toggle="button"
                    data-more="#sh" aria-pressed="false">
                    <i class="ti ti-plus fs-7 text"></i>
                    <i class="ti ti-minus fs-7 text-active"></i>
                  </button>

                  <button type="button" class="btn btn-light-secondary text-secondary" data-bs-toggle="button"
                    aria-pressed="true">
                    <span class="text">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 d-flex align-items-stretch">
            <!-- ---------------------
                                                  start Nesting buttons with small size
                                              ---------------- -->
            <div class="card w-100">
              <div class="card-body">
                <div class="mb-4">
                ...
                <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                  <button type="button" class="btn btn-light-secondary btn-sm text-secondary font-medium">
                    1
                  </button>
                  <button type="button" class="btn btn-light-secondary btn-sm text-secondary font-medium">
                    2
                  ...
                  <div class="btn-group btn-group-sm" role="group">
                    <button id="btnGroupDrop1" type="button"
                      class="btn btn-light-secondary text-secondary font-medium dropdown-toggle"
                ...
                <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                  <button type="button" class="btn btn-light-secondary btn-lg text-secondary font-medium">
                    1
                  </button>
                  <button type="button" class="btn btn-light-secondary btn-lg text-secondary font-medium">
                    2
            ...
            <!-- ---------------------
                                                  end Nesting buttons with small size
                                              ---------------- -->
          </div>
          ...
          <div class="col-lg-6 d-flex align-items-stretch">
            <!-- ---------------------
                                                  start Nesting Buttons with vertical align
                                              ---------------- -->
            <div class="card w-100">
              <div class="card-body">
                <div class="mb-4">
            ...
            <!-- ---------------------
                                                  end Nesting Buttons with vertical align
                                              ---------------- -->
          </div>
        </div>
        <!-- --------------------------------------------------- -->
...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/ui-buttons.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:42 GMT -->
</html>