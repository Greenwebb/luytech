...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/authentication-two-steps2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:54:31 GMT -->
<head>
    <!--  Title -->
            ...
            <div class="col-md-8 col-lg-6 col-xxl-3">
              <div class="card mb-0">
                <div class="card-body pt-5">
                  <a href="{{ route('index') }}" class="text-nowrap w-100 logo-img text-center d-block mb-4">
