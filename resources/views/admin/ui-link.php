...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/ui-link.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:53 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
            ...
            <div class="col-lg-6 d-flex align-items-stretch">
              <div class="card w-100">
                <div class="card-body">
                  ...
                  <p><a class="link-opacity-10 text-decoration-underline" href="#">Link opacity 10</a></p>
                  <p><a class="link-opacity-25 text-decoration-underline" href="#">Link opacity 25</a></p>
                  <p><a class="link-opacity-50 text-decoration-underline" href="#">Link opacity 50</a></p>
                  <p><a class="link-opacity-75 text-decoration-underline" href="#">Link opacity 75</a></p>
                  <p><a class="link-opacity-100 text-decoration-underline" href="#">Link opacity 100</a></p>
                </div>
              </div>
            </div>
            <div class="col-lg-6 d-flex align-items-stretch">
              <div class="card w-100">
                <div class="card-body">
                  ...
                  <p><a class="link-opacity-10-hover text-decoration-underline" href="#">Link hover opacity 10</a></p>
                  <p><a class="link-opacity-25-hover text-decoration-underline" href="#">Link hover opacity 25</a></p>
                  <p><a class="link-opacity-50-hover text-decoration-underline" href="#">Link hover opacity 50</a></p>
                  <p><a class="link-opacity-75-hover text-decoration-underline" href="#">Link hover opacity 75</a></p>
                  <p><a class="link-opacity-100-hover text-decoration-underline" href="#">Link hover opacity 100</a></p>
                </div>
              </div>
            </div>
            <div class="col-lg-6 d-flex align-items-stretch">
              <div class="card w-100">
                <div class="card-body">
                  ...
                  <p><a href="#" class="link-underline-dark text-decoration-underline">Dark underline</a></p>
                </div>
              </div>
            </div>
            <div class="col-lg-6 d-flex align-items-stretch">
              <div class="card w-100">
                <div class="card-body">
                  ...
                  <p><a class="link-offset-3 text-decoration-underline" href="#">Offset 3 link</a></p>
                </div>
              </div>
            </div>
            <div class="col-lg-6 d-flex align-items-stretch">
              <div class="card w-100">
                <div class="card-body">
                  ...
                  <p><a class="link-offset-2 text-decoration-underline link-underline link-underline-opacity-100" href="#">Underline opacity 100</a></p>
                </div>
              </div>
            </div>
            <div class="col-lg-6 d-flex align-items-stretch">
            ...
            <div class="col-lg-6 d-flex align-items-stretch">
              <div class="card w-100">
                <div class="card-body">
                  ...
                  <p><a href="#" class="link-body-emphasis link-offset-2 text-decoration-underline link-underline-opacity-25 link-underline-opacity-75-hover">Emphasis link</a></p>
                </div>
              </div>
            </div>
          </div>
