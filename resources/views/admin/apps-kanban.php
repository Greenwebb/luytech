...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/apps-kanban.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:02 GMT -->
<head>
  <!-- --------------------------------------------------- -->
  <!-- Title -->
  <!-- --------------------------------------------------- -->
...
<body>
                ...
                <div class="row">
                  ...
                  <div class="col-4 ms-n4">
                    <div class="position-relative p-7 border-start h-100">
                      ...
                      <ul class="">
                        <li class="mb-3">
                          <a class="fw-semibold text-dark bg-hover-primary    " href="page-pricing.php">Pricing
                            Page</a>
                        </li>
                        <li class="mb-3">
                        ...
                        <li class="mb-3">
                          <a class="fw-semibold text-dark bg-hover-primary    " href="authentication-error.php">404
                            Error Page</a>
                        </li>
                        <li class="mb-3">
                    ...
                    <div class="profile-dropdown position-relative" data-simplebar>
                      ...
                      <div class="d-flex align-items-center py-9 mx-7 border-bottom">
                        ...
                        <div class="ms-3">
                          ...
                          <p class="mb-0 d-flex text-dark align-items-center gap-2"><i class="ti ti-mail fs-4"></i>
                            info@modernize.com</p>
                        </div>
                      </div>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer justify-content-start">
                ...
                <button data-btn-action="editTask" class="btn edit-tsk btn-success" style="display: none;">Save</button>
                    ...
                    <div data-draggable="true" class="card img-task">
                      <div class="card-body">
                        ...
                        <div class="task-header">
                          <div class="">
                            <h4 class="" data-item-title="This is first task">
                        ...
                        <div class="task-content p-0">
                          <img src="../../dist/images/backgrounds/kanban-img-1.jpg" class="img-fluid" alt="scrumboard">
                        </div>
                  ...
                  <div class="connect-sorting-content" data-sortable="true">
                    ...
                    <div data-draggable="true" class="card img-task">
                      <div class="card-body">
                        ...
                        <div class="task-content p-0">
                          <img src="../../dist/images/backgrounds/kanban-img-2.jpg" class="img-fluid" alt="scrumboard">
                        </div>
                  ...
                  <div class="connect-sorting-content" data-sortable="true">
                      ...
                      <div class="card-body">
                        ...
                        <div class="task-content">
                          <p class="mb-0"
                            ...
                            Create user personas based on the research data to represent different user groups and their
                    ...
                    <div data-draggable="true" class="card img-task">
                      <div class="card-body">
                        ...
                        <div class="task-content p-0">
                          <img src="../../dist/images/backgrounds/my-card.jpg" class="img-fluid" alt="scrumboard">
                        </div>
                  ...
                  <div class="connect-sorting-content" data-sortable="true">
                    ...
                    <div data-draggable="true" class="card img-task">
                      <div class="card-body">
                        ...
                        <div class="task-content p-0">
                          <img src="../../dist/images/backgrounds/weatherbg.jpg" class="img-fluid" alt="scrumboard">
                        </div>
            ...
            <div>
              ...
              <div class="d-flex align-items-center justify-content-between mt-2">
                ...
                <div class="input-group input-group-sm w-50">
                  <button class="btn border-0 round-20 minus p-0 bg-light-success text-success" type="button" id="add1">
                    -
                  </button>
                  <input type="text"
                    class="form-control round-20 bg-transparent text-muted fs-2 border-0 text-center qty" placeholder=""
                    aria-label="Example text with button addon" aria-describedby="add1" value="1" />
          ...
          <div class="d-flex align-items-center">
            ...
            <div>
              ...
              <div class="d-flex align-items-center justify-content-between mt-2">
                <h6 class="fs-2 fw-semibold mb-0 text-muted">$250</h6>
                <div class="input-group input-group-sm w-50">
                  <button class="btn border-0 round-20 minus p-0 bg-light-success text-success" type="button" id="add2">
                    -
                  </button>
                  <input type="text"
                    class="form-control round-20 bg-transparent text-muted fs-2 border-0 text-center qty" placeholder=""
                    aria-label="Example text with button addon" aria-describedby="add2" value="1" />
          ...
          <div class="d-flex align-items-center">
            ...
            <div>
              ...
              <div class="d-flex align-items-center justify-content-between mt-2">
                <h6 class="fs-2 fw-semibold mb-0 text-muted">$250</h6>
                <div class="input-group input-group-sm w-50">
                  <button class="btn border-0 round-20 minus p-0 bg-light-success text-success" type="button" id="add3">
                    -
                  </button>
                  <input type="text"
                    class="form-control round-20 bg-transparent text-muted fs-2 border-0 text-center qty" placeholder=""
                    aria-label="Example text with button addon" aria-describedby="add3" value="1" />
                  <button class="btn text-success bg-light-success p-0 round-20 border-0 add" type="button" id="addon3">
                    +
                  </button>
                </div>
              </div>
  ...
  <!-- ---------------------------------------------- -->
  <script src="../../dist/js/apps/kanban.js"></script>
</body>


<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/apps-kanban.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:04 GMT -->
</html>