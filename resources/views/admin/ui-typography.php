...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/ui-typography.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:45 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover mb-0">
                      ...
                      <tbody class="border-top">
                        <tr>
                          <th scope="row">
                            <h6><span class="badge bg-info">mark</span></h6>
                          </th>
                          <td>
                            <p class="mb-0">
                        ...
                        <tr>
                          <th scope="row">
                            <h6><span class="badge bg-info">del</span></h6>
                          </th>
                          <td>
                            <p class="mb-0">
                        ...
                        <tr>
                          <th scope="row">
                            <h6><span class="badge bg-info">s</span></h6>
                          </th>
                          <td>
                            <p class="mb-0">
                        ...
                        <tr>
                          <th scope="row">
                            <h6><span class="badge bg-info">ins</span></h6>
                          </th>
                          <td>
                            <p class="mb-0">
                        ...
                        <tr>
                          <th scope="row">
                            <h6><span class="badge bg-info">u</span></h6>
                          </th>
                          <td>
                            <p class="mb-0">
                        ...
                        <tr>
                          <th scope="row">
                            <h6><span class="badge bg-info">small</span></h6>
                          </th>
                          <td>
                            <p class="mb-0">
                        ...
                        <tr>
                          <th scope="row">
                            <h6><span class="badge bg-info">strong</span></h6>
                          </th>
                          <td>
                            <p class="mb-0">
                        ...
                        <tr>
                          <th scope="row">
                            <h6><span class="badge bg-info">em</span></h6>
                          </th>
                          <td>
                            <p class="mb-0">
                ...
                <div class="card w-100">
                  <div class="card-body">
                    ...
                    <p class="mb-3 card-subtitle">
                      ...
                      placed outside the
                      <mark><code>&lt;blockquote&gt;</code></mark
