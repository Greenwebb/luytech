...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/ui-offcanvas.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:49 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
                ...
                <div class="card w-100">
                  <div class="card-body">
                    ...
                    <div class="button-group">
                      <a
                        class="btn mb-1 btn-light-primary text-primary"
                      ...
                      <button
                        class="btn mb-1 btn-light-info text-info"
                        type="button"
                        data-bs-toggle="offcanvas"
                      ...
                      <button
                        class="btn mb-1 btn-light-danger text-danger"
                        type="button"
                        data-bs-toggle="offcanvas"
                      ...
                      <button
                        class="btn mb-1 btn-light-warning text-warning"
                        type="button"
                        data-bs-toggle="offcanvas"
                      ...
                      <button
                        class="btn mb-1 btn-light-secondary text-secondary"
                        type="button"
                        data-bs-toggle="offcanvas"
                      ...
                      <button
                        class="btn mb-1 btn-light-success text-success"
                        type="button"
                        data-bs-toggle="offcanvas"
