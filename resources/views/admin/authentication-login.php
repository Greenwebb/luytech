...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/authentication-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:54:31 GMT -->
<head>
    <!--  Title -->
        ...
        <div class="position-relative z-index-5">
          <div class="row">
            <div class="col-xl-7 col-xxl-8">
              <a href="{{ route('index') }}" class="text-nowrap logo-img d-block px-4 py-9 w-100">
                ...
                <div class="col-sm-8 col-md-6 col-xl-9">
                  ...
                  <form>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      ...
                      <a class="text-primary fw-medium" href="authentication-forgot-password.php">Forgot Password ?</a>
                    </div>
                    <a href="{{ route('index') }}" class="btn btn-primary w-100 py-8 mb-4 rounded-2">Sign In</a>
                    <div class="d-flex align-items-center justify-content-center">
                      <p class="fs-4 mb-0 fw-medium">New to Modernize?</p>
                      <a class="text-primary fw-medium ms-2" href="authentication-register.php">Create an account</a>
                    </div>
                  </form>
                </div>
              </div>
