...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/table-bootstrap.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:54:20 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
        ...
        <div class="container-fluid">
            ...
            <div class="col-12">
              <div class="card">
                <div class="border-bottom title-part-padding">
                  <h4 class="card-title mb-0">Bootstrap Simple Table</h4>
                </div>
                <div class="card-body">
                  <h6 class="card-subtitle mb-3">Simple table example</h6>
                  <table data-bs-toggle="table" data-height="250" data-mobile-responsive="true" class="table-striped">
                    <thead>
                      <tr>
                        <th>Name</th>
                        <th>Stars</th>
                    ...
                    <tbody>
                      <tr id="tr-id-1" class="tr-class-1">
                        ...
                        <td>122</td>
                        <td>
                          An extended Bootstrap table with radio, checkbox,
                          sort, pagination, and other added features. (supports
                      ...
                      <tr id="tr-id-2" class="tr-class-2">
                        ...
                        <td>150</td>
                        <td>
                          A jQuery plugin to select multiple elements with
                          checkboxes :)
                        </td>
                      </tr>
              ...
              <div class="card">
                <div class="border-bottom title-part-padding">
                  <h4 class="card-title mb-0">Bootstrap Data From js</h4>
                </div>
                <div class="card-body">
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="card">
                <div class="border-bottom title-part-padding">
                  <h4 class="card-title mb-0">Table with radio button</h4>
                </div>
                <div class="card-body">
                  <h6 class="card-subtitle mb-3">data with radiobutton</h6>
                  <table data-bs-toggle="table" data-url="../../dist/js/plugins/tables/data1.json"
            ...
            <div class="col-lg-6">
              <div class="card">
                <div class="border-bottom title-part-padding">
                  <h4 class="card-title mb-0">Table with checkbox</h4>
                </div>
                <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="border-bottom title-part-padding">
                  <h4 class="card-title mb-0">Sub table</h4>
                </div>
                <div class="card-body">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="border-bottom title-part-padding">
                  <h4 class="card-title mb-0">Table Locale</h4>
                </div>
                <div class="card-body">
                  <div class="toolbar">
                    <select class="form-select" id="locale">
                  ...
                  <table id="localetable" data-locale="zh-CN" data-height="460" data-toolbar=".toolbar"
                    ...
                    data-show-export="true" data-pagination="true" data-url="../../dist/js/plugins/tables/data1.json">
                    <thead>
                      <tr>
                        <th data-field="id">ID</th>
                        <th data-field="name">Item Name</th>
  ...
  <div class="offcanvas offcanvas-end customizer" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" data-simplebar="">
    ...
    <!-- ---------------------------------------------- -->
    <script src="../../../../../../../unpkg.com/tableexport.jquery.plugin%401.28.0/tableExport.min.js"></script>
    <script src="../../dist/libs/bootstrap-table/dist/bootstrap-table.min.js"></script>
    <script src="../../dist/js/plugins/tables/bootstrap-table.init.js"></script>
  </body>

<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/table-bootstrap.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:54:24 GMT -->
</html>
