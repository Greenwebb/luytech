...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/ui-lists.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:49 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
                ...
                <div class="card-body">
                  ...
                  <ul class="list-group">
                    <li class="list-group-item d-flex align-items-center">
                      ...
                      Todo List 1
                      <span
                        class="badge bg-light-primary text-primary font-medium rounded-pill ms-auto"
                        >14</span
                      >
                    </li>
                    <li class="list-group-item d-flex align-items-center">
                      ...
                      Todo List 2
                      <span
                        class="badge bg-light-danger text-danger font-medium rounded-pill ms-auto"
                        >10</span
                      >
                    </li>
                    <li class="list-group-item d-flex align-items-center">
                      ...
                      Todo List 3
                      <span
                        class="badge bg-light-success text-success font-medium rounded-pill ms-auto"
                        >01</span
                      >
                    </li>
                  </ul>
