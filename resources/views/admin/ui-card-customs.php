...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/ui-card-customs.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:54 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
            ...
            <div class="col-12">
              ...
              <div class="row">
                <div class="col-md-4 col-lg-2">
                  <div class="card text-center alert-dismissible fade show alert p-0 card-hover bg-white"
                    role="alert">
                    ...
                    <div class="p-2 d-block mt-3">
                      ...
                      <a href="#"
                        class="btn btn-light-success text-success  d-block w-100">Message</a>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 col-lg-2">
                  <div class="card text-center alert-dismissible fade show alert p-0 card-hover bg-white"
                    ...
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    <div class="p-2 d-block mt-3">
                      <img src="../../dist/images/profile/user-3.jpg" width="75" class="rounded-circle img-fluid" />
                      <h5 class="card-title mt-3">John Deo</h5>
                      <span class="badge bg-light-warning text-warning rounded-pill mb-3">away</span>
                      <a href="#"
                        class="btn btn-light-warning text-warning  d-block w-100">Message</a>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 col-lg-2">
                  <div class="card text-center alert-dismissible fade show alert p-0 card-hover bg-white"
                    ...
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    <div class="p-2 d-block mt-3">
                      <img src="../../dist/images/profile/user-1.jpg" width="75" class="rounded-circle img-fluid" />
                      <h5 class="card-title mt-3">John Deo</h5>
                      <span class="badge bg-light-success text-success rounded-pill mb-3">active</span>
                      <a href="#"
                        class="btn btn-light-primary text-primary  d-block w-100">Message</a>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 col-lg-2">
                  <div class="card text-center alert-dismissible fade show alert p-0 card-hover bg-white"
                    ...
                    <div class="p-2 d-block mt-3">
                      <img src="../../dist/images/profile/user-5.jpg" width="75" class="rounded-circle img-fluid" />
                      <h5 class="card-title mt-3">John Deo</h5>
                      <span class="badge bg-light-secondary text-secondary rounded-pill mb-3">offline</span>
                      <a href="#"
                        class="btn btn-light-secondary text-secondary  d-block w-100">Message</a>
                    </div>
                  </div>
                </div>
                <div class="col-md-4 col-lg-2">
                ...
                <div class="col-md-4 col-lg-2">
                  <div class="card text-center alert-dismissible fade show alert p-0 card-hover bg-white"
                    ...
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    <div class="p-2 d-block mt-3">
                      <img src="../../dist/images/profile/user-6.jpg" width="75" class="rounded-circle img-fluid" />
                      <h5 class="card-title mt-3">John Deo</h5>
                      <span class="badge bg-light-secondary text-secondary rounded-pill mb-3">offline</span>
                      <a href="#"
                        class="btn btn-light-secondary text-secondary  d-block w-100">Message</a>
              ...
              <div class="row">
                <div class="col-lg-4 col-md-6">
                  <div class="card text-center">
                    <div class="card-body">
                      <img src="../../dist/images/profile/user-1.jpg" class="rounded-1 img-fluid" width="90" />
                      <div class="mt-n2">
                      ...
                      <div class="row mt-3 justify-content-center">
                        <div class="col-6">
                          <div class="py-2 px-3 bg-light rounded-pill d-flex align-items-center">
                            <span class="text-warning"><i class="ti ti-star-filled fs-8"></i></span>
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="card text-center">
                    <div class="card-body">
                      <img src="../../dist/images/profile/user-2.jpg" class="rounded-1 img-fluid" width="90" />
                      <div class="mt-n2">
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="card text-center">
                    <div class="card-body">
                      <img src="../../dist/images/profile/user-3.jpg" class="rounded-1 img-fluid" width="90" />
                      <div class="mt-n2">
                        <span class="badge bg-warning">Desinger</span>
                        <h3 class="card-title mt-3">Matt Carlson</h3>
                        <h6 class="card-subtitle">San Francisco, CA</h6>
                      </div>
                      <div class="row mt-3 justify-content-center">
                ...
                <div class="col-lg-4">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row pt-3">
                        <div class="col-3">
                          <div class="bg-light-info text-info text-center py-2 rounded-1">
                ...
                <div class="col-lg-4">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row pt-3">
                        <div class="col-3">
                          <div class="bg-light-secondary text-secondary text-center py-2 rounded-1">
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-3">
                          <div
                            class="bg-light-warning text-warning rounded d-flex align-items-center p-8 justify-content-center">
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <div class="progress mt-3 bg-light">
                        <div class="progress-bar bg-primary" role="progressbar" style="width: 26%; height: 6px;"
                          aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-3">
                          <div
                            class="bg-light-danger text-danger rounded d-flex align-items-center p-8 justify-content-center">
                      ...
                      <div class="progress mt-3 bg-light">
                        <div class="progress-bar bg-danger" role="progressbar" style="width: 26%; height: 6px;"
                          aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-3">
                          <div
                            class="bg-light-success text-success rounded d-flex align-items-center p-8 justify-content-center">
                      ...
                      <div class="progress mt-3 bg-light">
                        <div class="progress-bar bg-success" role="progressbar" style="width: 26%; height: 6px;"
                          aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-3">
                          <div
                            class="bg-light-info text-info rounded d-flex align-items-center p-8 justify-content-center">
                            <i class="ti ti-brand-messenger fs-8"></i>
                          </div>
                        </div>
                        <div class="col-9 d-flex align-items-center justify-content-end text-end">
                      ...
                      <div class="progress mt-3 bg-light">
                        <div class="progress-bar bg-info" role="progressbar" style="width: 26%; height: 6px;"
                          aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-3">
                          <div
                            class="bg-light-secondary text-secondary rounded d-flex align-items-center p-8 justify-content-center">
                            <i class="ti ti-brand-drops fs-8"></i>
                          </div>
                        </div>
                        <div class="col-9 d-flex align-items-center justify-content-end text-end">
                      ...
                      <div class="progress mt-3 bg-light">
                        <div class="progress-bar bg-secondary" role="progressbar" style="width: 26%; height: 6px;"
                          aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row">
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="d-flex no-block align-items-center mb-3">
                        <span class="d-flex align-items-center"><i class="ti ti-calendar me-1 fs-5"></i> 20 May 2023</span>
                        <div class="ms-auto">
                          <a href="javascript:void(0)" class="link text-muted"><i class="ti ti-message-circle me-1 fs-5"></i> 3 Comments</a>
                        </div>
                      </div>
                      <h3 class="fs-6">
                ...
                <div class="col-lg-4">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="d-flex no-block align-items-center mb-3">
                        <span class="d-flex align-items-center"><i class="ti ti-calendar me-1 fs-5"></i> 19 May 2023</span>
                        <div class="ms-auto">
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-12">
                          <div class="progress bg-light">
                            <div class="progress-bar bg-info" role="progressbar" style="width: 40%; height: 6px;"
                              aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-12">
                          <div class="progress bg-light">
                            <div class="progress-bar bg-dark" role="progressbar" style="width: 26%; height: 6px;"
                              aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                          </div>
                        </div>
                      </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="card">
                    <div class="bg-info p-4 rounded-3 rounded-bottom-0">
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="card">
                    <div class="bg-primary p-4 rounded-3 rounded-bottom-0">
                      <div class="text-center text-white display-6">
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="card">
                    <div class="bg-success p-4 rounded-3 rounded-bottom-0">
                      <div class="text-center text-white display-6">
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="card">
                    <div class="bg-dark p-4 rounded-3 rounded-bottom-0">
                      <div class="text-center text-white display-6">
              ...
              <div class="row">
                <div class="col-lg-3 col-md-6">
                  <div class="card bg-dark text-white">
                    <div class="card-body">
                      <div class="d-flex no-block align-items-center">
                        <a href="JavaScript: void(0);"><i class="ti ti-currency-ethereum display-6 text-white" title="ETH"></i></a>
                        <div class="ms-3 mt-2">
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="card bg-primary text-white">
                    <div class="card-body">
                      <div class="d-flex no-block align-items-center">
                        <a href="JavaScript: void(0);"><i class="ti ti-currency-dogecoin display-6 text-white" title="LTC"></i></a>
                        <div class="ms-3 mt-2">
                          <h4 class=" mb-0 text-white">
                            Dash
                          </h4>
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="card bg-danger text-white">
                    <div class="card-body">
                      <div class="d-flex no-block align-items-center">
                        <a href="JavaScript: void(0);"><i class="ti ti-currency-bitcoin display-6 text-white" title="BTC"></i></a>
                        <div class="ms-3 mt-2">
                          <h4 class=" mb-0 text-white">
                            Bitcoin
                          </h4>
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="card bg-info text-white">
                    <div class="card-body">
                      <div class="d-flex no-block align-items-center">
                        <a href="JavaScript: void(0);"><i class="ti ti-currency-ripple display-6 text-white" title="AMP"></i></a>
                        <div class="ms-3 mt-2">
                          <h4 class=" mb-0 text-white">
                            Ripple
                          </h4>
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item flex-column">
                            ...
                            <div class="row text-center text-white mt-4">
                              <div class="col-4">
                                ...
                                <p class=""><i class="ti ti-arrow-up fs-5"></i> 0.08</p>
                              </div>
                              <div class="col-4">
                                <span class="fs-3">% 24h</span>
                                <p class=""><i class="ti ti-arrow-down fs-5"></i> -1.06</p>
                              </div>
                              <div class="col-4">
                                <span class="fs-3">% 7d</span>
                                <p class=""><i class="ti ti-arrow-up fs-5"></i> -20.10</p>
                              </div>
                            </div>
                          </div>
                          <div class="carousel-item flex-column">
                            <div class="d-flex no-block align-items-center me-3">
                              <i class="ti ti-currency-bitcoin display-6 text-white me-3" title="BTC"></i>
                              <div class="mt-2">
                                <h5 class="text-white ">
                                  Bitcoin
                                </h5>
                            ...
                            <div class="row text-center text-white mt-4">
                              <div class="col-4">
                                <span class="fs-3">% 1h</span>
                                <p class=""><i class="ti ti-arrow-up fs-5"></i> 2.08</p>
                              </div>
                              <div class="col-4">
                                <span class="fs-3">% 24h</span>
                                <p class=""><i class="ti ti-arrow-down fs-5"></i> -3.06</p>
                              </div>
                              <div class="col-4">
                                <span class="fs-3">% 7d</span>
                                <p class=""><i class="ti ti-arrow-up fs-5"></i> -21.01</p>
                              </div>
                            </div>
                          </div>
                          <div class="carousel-item flex-column active">
                            ...
                            <div class="row text-center text-white mt-4">
                              <div class="col-4">
                                <span class="fs-3">% 1h</span>
                                <p class=""><i class="ti ti-arrow-up fs-5"></i> 0.12</p>
                              </div>
                              <div class="col-4">
                                <span class="fs-3">% 24h</span>
                                <p class=""><i class="ti ti-arrow-down fs-5"></i> -1.06</p>
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item flex-column">
                            <div class="d-flex no-block al me-3ign-items-center">
                              <i class="ti ti-currency-euro display-6 text-white me-3" title="EOS"></i>
                              <div class="mt-2">
                                <h5 class="text-white ">
                                  EOS
                                </h5>
                            ...
                            <div class="row text-center text-white mt-4">
                              <div class="col-4">
                                <span class="fs-3">% 1h</span>
                                <p class=""><i class="ti ti-arrow-up fs-5"></i> 0.18</p>
                              </div>
                              <div class="col-4">
                                <span class="fs-3">% 24h</span>
                                <p class=""><i class="ti ti-arrow-down fs-5"></i> -5.10</p>
                              </div>
                              <div class="col-4">
                                <span class="fs-3">% 7d</span>
                                <p class=""><i class="ti ti-arrow-up fs-5"></i> -0.10</p>
                              </div>
                            </div>
                          </div>
                          <div class="carousel-item flex-column">
                            ...
                            <div class="row text-center text-white mt-4">
                              <div class="col-4">
                                <span class="fs-3">% 1h</span>
                                <p class=""><i class="ti ti-arrow-up fs-5"></i> 1.08</p>
                              </div>
                              <div class="col-4">
                                <span class="fs-3">% 24h</span>
                                <p class=""><i class="ti ti-arrow-down fs-5"></i> -1.16</p>
                              </div>
                              <div class="col-4">
                                <span class="fs-3">% 7d</span>
                                <p class=""><i class="ti ti-arrow-up fs-5"></i> -1.01</p>
                              </div>
                            </div>
                          </div>
                          <div class="carousel-item flex-column active">
                            ...
                            <div class="row text-center text-white mt-4">
                              <div class="col-4">
                                <span class="fs-3">% 1h</span>
                                <p class=""><i class="ti ti-arrow-up fs-5"></i> 2.16</p>
                              </div>
                              <div class="col-4">
                                <span class="fs-3">% 24h</span>
                                <p class=""><i class="ti ti-arrow-down fs-5"></i> -1.00</p>
                              </div>
                              <div class="col-4">
                                <span class="fs-3">% 7d</span>
                                <p class=""><i class="ti ti-arrow-up fs-5"></i> -2.08</p>
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item flex-column">
                            ...
                            <div class="row text-center text-white mt-4">
                              <div class="col-4">
                                <span class="fs-3">% 1h</span>
                                <p class=""><i class="ti ti-arrow-up fs-5"></i> 1.18</p>
                              </div>
                              <div class="col-4">
                                <span class="fs-3">% 24h</span>
                                <p class=""><i class="ti ti-arrow-down fs-5"></i> -5.16</p>
                              </div>
                              <div class="col-4">
                                <span class="fs-3">% 7d</span>
                                <p class=""><i class="ti ti-arrow-up fs-5"></i> -20.10</p>
                          ...
                          <div class="carousel-item flex-column active">
                            ...
                            <div class="row text-center text-white mt-4">
                              <div class="col-4">
                                <span class="fs-3">% 1h</span>
                                <p class=""><i class="ti ti-arrow-up fs-5"></i> 1.02</p>
                              </div>
                              <div class="col-4">
                                <span class="fs-3">% 24h</span>
                                <p class=""><i class="ti ti-arrow-down fs-5"></i> -3.16</p>
                              </div>
                              <div class="col-4">
                                <span class="fs-3">% 7d</span>
                                <p class=""><i class="ti ti-arrow-up fs-5"></i> -10.00</p>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="card-body">
                      <div id="myCarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item flex-column">
                            <div class="d-flex no-block al me-3ign-items-center">
                              <i class="ti ti-currency-baht display-6 text-white me-3" title="BTM"></i>
                              <div class="mt-2">
                                <h5 class="text-white ">
                                  Bitmark
                                </h5>
                            ...
                            <div class="row text-center text-white mt-4">
                              ...
                              <div class="col-4">
                                <span class="fs-3">% 24h</span>
                                <p class=""><i class="ti ti-arrow-down fs-5"></i> -2.06</p>
                              </div>
                              <div class="col-4">
                                <span class="fs-3">% 7d</span>
                                <p class=""><i class="ti ti-arrow-up fs-5"></i> -1.10</p>
                              </div>
                            </div>
                          </div>
                          <div class="carousel-item flex-column">
                            ...
                            <div class="row text-center text-white mt-4">
                              <div class="col-4">
                                <span class="fs-3">% 1h</span>
                                <p class=""><i class="ti ti-arrow-up fs-5"></i> 2.18</p>
                              </div>
                              <div class="col-4">
                                <span class="fs-3">% 24h</span>
                                <p class=""><i class="ti ti-arrow-down fs-5"></i> -3.16</p>
                              ...
                              <div class="col-4">
                                <span class="fs-3">% 7d</span>
                                <p class=""><i class="ti ti-arrow-up fs-5"></i> -2.01</p>
                              </div>
                            </div>
                          </div>
                          <div class="carousel-item flex-column active">
                            ...
                            <div class="row text-center text-white mt-4">
                              ...
                              <div class="col-4">
                                <span class="fs-3">% 7d</span>
                                <p class=""><i class="ti ti-arrow-up fs-5"></i> -1s.08</p>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="card-body">
                      <div id="myCarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item flex-column">
                            <div class="d-flex no-block align-items-center me-3">
                              <i class="ti ti-currency-dogecoin display-6 text-white me-3" title="DASH"></i>
                              <div class="mt-2">
                                <h5 class="text-white ">
                                  Dash
                                </h5>
                            ...
                            <div class="row text-center text-white mt-4">
                              ...
                              <div class="col-4">
                                <span class="fs-3">% 24h</span>
                                <p class=""><i class="ti ti-arrow-down fs-5"></i> -1.10</p>
                              </div>
                              <div class="col-4">
                                <span class="fs-3">% 7d</span>
                                <p class=""><i class="ti ti-arrow-up fs-5"></i> -0.20</p>
                              </div>
                            </div>
                          </div>
                          <div class="carousel-item flex-column">
                          ...
                          <div class="carousel-item flex-column active">
                            ...
                            <div class="row text-center text-white mt-4">
                              <div class="col-4">
                                <span class="fs-3">% 1h</span>
                                <p class=""><i class="ti ti-arrow-up fs-5"></i> 1.16</p>
                              </div>
                              <div class="col-4">
                                <span class="fs-3">% 24h</span>
                                <p class=""><i class="ti ti-arrow-down fs-5"></i> -1.10</p>
                    ...
                    <div class="card-body">
                      <div id="myCarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                          <div class="carousel-item flex-column">
                            <div class="d-flex no-block al me-3ign-items-center">
                              <i class="ti ti-diamond display-6 text-dark me-3" title="GEMZ"></i>
                              <div class="mt-2">
                                <h5 class="text-dark ">
                                  GetGems
                                </h5>
                          ...
                          <div class="carousel-item flex-column">
                            ...
                            <div class="row text-center text-dark mt-4">
                              ...
                              <div class="col-4">
                                <span class="fs-3">% 7d</span>
                                <p class=""><i class="ti ti-arrow-up fs-5"></i> -1.11</p>
                              </div>
                            </div>
                          </div>
                          <div class="carousel-item flex-column active">
                            ...
                            <div class="row text-center text-dark mt-4">
                              <div class="col-4">
                                <span class="fs-3">% 1h</span>
                                <p class=""><i class="ti ti-arrow-up fs-5"></i> 12.16</p>
                              </div>
                              <div class="col-4">
                                <span class="fs-3">% 24h</span>
                                <p class=""><i class="ti ti-arrow-down fs-5"></i> -1.10</p>
              ...
              <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="card overflow-hidden">
                    <div class="d-flex flex-row">
                      <div class="p-3 bg-light-success">
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="card overflow-hidden">
                    <div class="d-flex flex-row">
                      ...
                      <div class="p-3 bg-light-info ms-auto">
                        <h3 class="text-info box mb-0">
                          <i class="ti ti-brand-messenger"></i>
                        </h3>
                      </div>
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="card overflow-hidden">
                    <div class="d-flex flex-row">
                      ...
                      <div class="p-3 bg-light-success ms-auto">
                        <h3 class="text-success box mb-0">
                          <i class="ti ti-building-broadcast-tower"></i>
                        </h3>
                      </div>
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="card overflow-hidden">
                    <div class="d-flex flex-row">
                      ...
                      <div class="p-3 bg-light-primary ms-auto">
                        <h3 class="text-primary box mb-0">
                          <i class="ti ti-clock-hour-3"></i>
                        </h3>
                      </div>
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="card overflow-hidden">
                    <div class="d-flex flex-row">
                      ...
                      <div class="p-3 bg-light-warning ms-auto">
                        <h3 class="text-warning box mb-0">
                          <i class="ti ti-database"></i>
                        </h3>
                      </div>
                ...
                <div class="col-sm-12 col-md-6">
                  <div class="card bg-info">
                    <div class="card-body text-white">
                      <div class="d-flex flex-row align-items-center">
                        <div
                          class="round-40 rounded-circle d-flex align-items-center justify-content-center bg-light-info text-info">
                          <i class="ti ti-credit-card fs-6"></i>
                        </div>
                        <div class="ms-3">
                ...
                <div class="col-sm-12 col-md-6">
                  <div class="card bg-danger">
                    <div class="card-body text-white">
                      <div class="d-flex flex-row align-items-center">
                        <div
                          class="round-40 rounded-circle d-flex align-items-center justify-content-center bg-light-danger text-danger">
                          <i class="ti ti-credit-card fs-6"></i>
                        </div>
                        <div class="ms-3">
                    ...
                    <div class="row pt-2 pb-2">
                      ...
                      <div class="col text-center align-self-center">
                        <div data-label="20%" class="css-bar mb-0 css-bar-danger css-bar-20">
                          <i class="display-6 ti ti-star-filled"></i>
                        </div>
                      </div>
                    </div>
                    <div class="row mt-3">
...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/ui-card-customs.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:55 GMT -->
</html>
