...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/ui-toasts.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:54:36 GMT -->
<head>
  <!-- --------------------------------------------------- -->
  <!-- Title -->
  <!-- --------------------------------------------------- -->
        ...
        <div class="card bg-light-info shadow-none position-relative overflow-hidden">
          <div class="card-body px-4 py-3">
            <div class="row align-items-center">
              <div class="col-9">
                <h4 class="fw-semibold mb-8">Toasts</h4>
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="text-muted " href="{{ route('index') }}">Dashboard</a></li>
                    <li class="breadcrumb-item" aria-current="page">Toasts</li>
                  </ol>
                </nav>
              </div>
              <div class="col-3">
        ...
        <div class="row">
          <div class="col-lg-6 d-flex align-items-stretch">
            <div class="card w-100">
              <div class="border-bottom py-6 px-7">
                <h4 class="card-title mb-0">Basic Toast</h4>
              </div>
              <div class="card-body p-4">
                <div class="bg-light p-3 rounded-1">
                  <div class="toast show overflow-hidden" role="alert" aria-live="assertive" aria-atomic="true">
          ...
          <div class="col-lg-6 d-flex align-items-stretch">
            <div class="card w-100">
              <div class="border-bottom py-6 px-7">
                <h4 class="card-title mb-0">Translucent toast</h4>
              </div>
              <div class="card-body p-4">
                <div class="bg-light p-3 rounded-1">
                  <div class="toast show overflow-hidden" role="alert" aria-live="assertive" aria-atomic="true">
          ...
          <div class="col-lg-6 d-flex align-items-stretch">
            <div class="card w-100">
              <div class="border-bottom py-6 px-7">
                <h4 class="card-title mb-0">Stacking toast</h4>
              </div>
              <div class="card-body p-4">
          ...
          <div class="col-lg-6 d-flex align-items-stretch">
            <div class="card w-100">
              ...
              <div class="card-body p-4">
                <div class="bg-light p-3 rounded-1">
                  <div class="toast show overflow-hidden mb-3" role="alert" aria-live="assertive" aria-atomic="true">
                    <div class="d-flex align-items-center">
                      <div class="toast-body">
                        Hello, world! This is a toast message.
                      </div>
          ...
          <div class="col-lg-6 d-flex align-items-stretch">
            <div class="card w-100">
              <div class="border-bottom py-6 px-7">
                <h4 class="card-title mb-0">Solid Color schemes</h4>
              </div>
              <div class="card-body p-4">
                <div class="bg-light p-3 rounded-1">
                  <div class="toast show mb-2 align-items-center text-bg-primary border-0" role="alert"
                  ...
                  <div class="toast show mb-2 align-items-center text-bg-secondary border-0" role="alert"
                    aria-live="assertive" aria-atomic="true">
                    <div class="d-flex">
                      <div class="toast-body">
                        Hello, world! This is a toast message.
                  ...
                  <div class="toast show mb-2 align-items-center text-bg-info border-0" role="alert"
                    aria-live="assertive" aria-atomic="true">
                    <div class="d-flex">
                      <div class="toast-body">
                        Hello, world! This is a toast message.
                  ...
                  <div class="toast show mb-2 align-items-center text-bg-danger border-0" role="alert"
                    aria-live="assertive" aria-atomic="true">
                    <div class="d-flex">
                      <div class="toast-body">
                        Hello, world! This is a toast message.
                  ...
                  <div class="toast show mb-2 align-items-center text-bg-warning border-0" role="alert"
                    aria-live="assertive" aria-atomic="true">
                    <div class="d-flex">
                      <div class="toast-body">
                        Hello, world! This is a toast message.
          ...
          <div class="col-lg-6 d-flex align-items-stretch">
            <div class="card w-100">
              ...
              <div class="card-body p-4">
                <div class="bg-light p-3 rounded-1">
                  <div class="toast show mb-2 align-items-center text-bg-light-primary text-primary border-0"
                  ...
                  <div class="toast show mb-2 align-items-center text-bg-light-secondary text-secondary border-0"
                    role="alert" aria-live="assertive" aria-atomic="true">
                    <div class="d-flex">
                      <div class="toast-body">
                        Hello, world! This is a toast message.
                  ...
                  <div class="toast show mb-2 align-items-center text-bg-light-info text-info border-0" role="alert"
                    aria-live="assertive" aria-atomic="true">
                    <div class="d-flex">
                      <div class="toast-body">
                        Hello, world! This is a toast message.
                  ...
                  <div class="toast show mb-2 align-items-center text-bg-light-danger text-danger border-0" role="alert"
                    aria-live="assertive" aria-atomic="true">
                    <div class="d-flex">
                      <div class="toast-body">
                        Hello, world! This is a toast message.
                  ...
                  <div class="toast show mb-2 align-items-center text-bg-light-warning text-warning border-0"
                    role="alert" aria-live="assertive" aria-atomic="true">
                    <div class="d-flex">
                      <div class="toast-body">
                        Hello, world! This is a toast message.
                  ...
                  <div class="toast show align-items-center text-bg-light-success text-success border-0" role="alert"
                    aria-live="assertive" aria-atomic="true">
                    <div class="d-flex">
                      <div class="toast-body">
                        Hello, world! This is a toast message.
              ...
              <div class="card-body p-4">
                <div class="bg-light p-3 rounded-1">
                  ...
                  <div aria-live="polite" aria-atomic="true"
                    class="bg-body-secondary position-relative bd-example-toasts" style="min-height: 240px;">
                    <div class="toast-container p-3" id="toastPlacement">
                      <div class="toast show overflow-hidden">
                        <div class="toast-header">
                          <i class="ti ti-chart-bubble-filled me-2 fs-5"></i>
                          <strong class="me-auto">Bootstrap</strong>
                          <small>11 mins ago</small>
