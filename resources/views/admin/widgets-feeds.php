...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/widgets-feeds.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:34 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
            ...
            <div class="col-md-6 col-lg-4">
              <div class="card">
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <div class="d-flex align-items-center">
                      <img src="../../dist/images/profile/user-1.jpg" class="rounded-pill img-fluid" width="50" />
                      <div class="ms-3">
                    ...
                    <div class="ms-auto">
                      <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                          ...
                          <li>
                            <a class="dropdown-item" href="#">Turn on Post Notifications</a>
                          </li>
                          <li>
                  ...
                  <img src="../../dist/images/big/img5.jpg" class="img-fluid rounded-1 mt-4" />
                  <div class="mt-4">
                    <p class="fs-4">
                      Your beauty is one of the things I like about you.😍 🥰<a href="#">#beauty</a>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <div class="d-flex align-items-center">
                      <img src="../../dist/images/profile/user-4.jpg" class="rounded-pill img-fluid" width="50" />
                      <div class="ms-3">
                  ...
                  <div class="d-flex align-items-start mt-3">
                    <img src="../../dist/images/profile/user-5.jpg" class="rounded-circle img-fluid" width="40" />
                    <div class="ms-3 w-100">
                      <h6 class="card-title mb-0">Andrew Grant</h6>
                      <div class="form-floating my-3">
                        <input type="text" class="form-control form-input-bg" id="floatingInput"
                          placeholder="name@example.com" />
                        <label for="floatingInput" class="text-secondary">Write comment...</label>
                      </div>
                      <div class="text-end">
                ...
                <div class="comment-widgets">
                  ...
                  <div class="d-flex flex-row comment-row mt-0 p-3">
                    <div class="p-2">
                      <img src="../../dist/images/profile/user-1.jpg" alt="user" width="50" class="rounded-circle" />
                    </div>
                    <div class="comment-text w-100">
                      ...
                      <div class="comment-footer d-md-flex align-items-center">
                        ...
                        <div class="action-icons ms-auto">
                          ...
                          <a href="javascript:void(0)"><i data-feather="check-circle" class="feather-sm"></i></a>
                  ...
                  <div class="d-flex flex-row comment-row p-3">
                    <div class="p-2">
                      <img src="../../dist/images/profile/user-4.jpg" alt="user" width="50" class="rounded-circle" />
                    </div>
                    <div class="comment-text w-100">
                      ...
                      <div class="comment-footer d-md-flex align-items-center">
                        ...
                        <div class="action-icons active ms-auto">
                          ...
                          <a href="javascript:void(0)"><i data-feather="heart" class="feather-sm text-danger"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-md-6 col-lg-4">
              <div class="card">
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <div class="d-flex align-items-center">
                      <img src="../../dist/images/profile/user-2.jpg" class="rounded-pill img-fluid" width="50" />
                      <div class="ms-3">
                ...
                <div class="card-body">
                  ...
                  <div class="mt-4">
                    <div class="embed-responsive embed-responsive-16by9">
                      <iframe class="embed-responsive-item rounded" width="100%" height="350"
                        src="https://www.youtube.com/embed/tgbNymZ7vqY" allowfullscreen="allowfullscreen"></iframe>
                    </div>
                  </div>
                  <div class="mt-4">
                    <p class="fs-4">
                  ...
                  <div class="mt-4 text-center">
                    <a href="#" class="link">
                      <div class="p-3 border rounded-1">
                        ...
                        <img src="../../dist/images/products/s4.jpg" class="img-fluid" />
                      </div>
                    </a>
                  </div>
                  <div class="mt-4">
                  ...
                  <div class="mt-4 text-center">
                    <a href="#" class="link">
                      <div class="p-3 border rounded-1">
                        ...
                        <img src="../../dist/images/products/s1.jpg" class="img-fluid" />
                      </div>
                    </a>
                  </div>
                  <div class="mt-4">
                    ...
                    <a href="#" class="text-info fs-4 font-weight-medium">https://www.polestar.com/us/pole-star-2/</a>
                  </div>
                  <div class="d-flex align-items-center mt-3">
                    <a href="#" class="me-3">
                      <i class="ti ti-heart text-dark fs-7"></i>
