...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/pages-search-result.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:54:27 GMT -->
<head>
    <!--  Title -->
                  ...
                  <ul class="search-listing list-style-none">
                    <li class="border-bottom">
                      ...
                      <a
                        ...
                        class="search-links p-0 text-success"
                        >http://www.google.com/angularjs</a
                      >
                      <p>
                    ...
                    <li class="border-bottom pt-3">
                      <h4 class="mb-0 fs-5">
                        <a
                          href="javacript:void(0)"
                          class=""
                          >AngularJS — Superheroic JavaScript MVW Framework</a
                        >
                      </h4>
                      <a
                        href="javascript:void(0)"
                    ...
                    <li class="border-bottom pt-3">
                      <h4 class="mb-0 fs-5">
                        <a
                          href="javacript:void(0)"
                          class=""
                          >AngularJS Tutorial - W3Schools</a
                        >
                      </h4>
                      <a
                        href="javascript:void(0)"
                    ...
                    <li class="border-bottom pt-3">
                      <h4 class="mb-0 fs-5">
                        <a
                          href="javacript:void(0)"
                          class=""
                          >Introduction to AngularJS - W3Schools</a
                        >
                      </h4>
                      <a
                        href="javascript:void(0)"
