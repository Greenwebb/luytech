...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-floating-input.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:54:00 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="floating-labels mt-4">
                    ...
                    <div class="form-group mb-5">
                      <input type="text" class="form-control" id="input5" data-bs-toggle="tooltip"
                        data-bs-placement="bottom" title="input with tooltip!!" />
                      <span class="bar"></span>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="floating-labels mt-4">
                    ...
                    <div class="form-group has-warning mb-5">
                    ...
                    <div class="form-group has-warning has-feedback mb-5">
                    ...
                    <div class="form-group has-success has-feedback mb-5">
