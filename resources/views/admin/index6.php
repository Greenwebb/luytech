...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/index6.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:51:08 GMT -->
<head>
    <!--  Title -->
                    ...
                    <div class="card-body px-3 py-4">
                            ...
                            <div class="jp-type-playlist">
                              ...
                              <div class="jp-gui">
                                <div class="jp-interface">
                                  <img src="../../dist/images/music/album3.jpg" class="rounded poster" alt="album" width="100" />
                      ...
                      <div class="d-flex align-items-center mt-3 p-3 bg-hover-light-black rounded border-bottom">
                        <div class="position-relative d-flex align-items-center">
                          ...
                          <img src="../../dist/images/music/album1.jpg" width="45" class="rounded" alt="album" />
                          <div class="ms-3">
                      ...
                      <div class="d-flex align-items-center bg-hover-light-black rounded p-3 border-bottom">
                        <div class="position-relative d-flex align-items-center">
                          <a href="javascript:void(0)" class="stretched-link "></a>
                          <img src="../../dist/images/music/album2.jpg" width="45" alt="album" class="rounded" />
                          <div class="ms-3">
                      ...
                      <div class="d-flex align-items-center p-3 bg-hover-light-black rounded">
                        <div class="position-relative d-flex align-items-center">
                          <a href="javascript:void(0)" class="stretched-link "></a>
                          <img src="../../dist/images/music/album4.jpg" width="45" alt="album" class="rounded" />
                          <div class="ms-3">
                ...
                <div class="card-body p-4">
                  ...
                  <div class="mt-4 overflow-auto gap-4" style="height: 450px" data-simplebar>
                    <a href="javascript:void(0)" class="mb-4 d-block">
                      <img src="../../dist/images/music/top10-1.jpg" class="img-fluid rounded" alt="album" />
                    </a>
                    <a href="javascript:void(0)" class="mb-4 d-block">
                      <img src="../../dist/images/music/top10-2.jpg" class="img-fluid rounded" alt="album" />
                    </a>
                    <a href="javascript:void(0)" class="d-block">
                      <img src="../../dist/images/music/top10-3.jpg" class="img-fluid rounded" alt="album" />
                    </a>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body p-4">
                  ...
                  <div class="overflow-auto card mt-4 mb-0 shadow-none border" style="height: 450px" data-simplebar>
                    <div class="hstack p-3 bg-hover-light-black position-relative border-bottom">
                      ...
                      <img src="../../dist/images/music/album1.jpg" alt="top-1" width="40" class="rounded ms-3" />
                      <div class="ms-3">
                    ...
                    <div class="hstack p-3 bg-hover-light-black position-relative border-bottom">
                      ...
                      <img src="../../dist/images/music/album2.jpg" alt="top-1" width="40" class="rounded ms-3" />
                      <div class="ms-3">
                    ...
                    <div class="hstack p-3 bg-hover-light-black position-relative border-bottom">
                      ...
                      <img src="../../dist/images/music/album3.jpg" alt="top-1" width="40" class="rounded ms-3" />
                      <div class="ms-3">
                    ...
                    <div class="hstack p-3 bg-hover-light-black position-relative border-bottom">
                      ...
                      <img src="../../dist/images/music/album4.jpg" alt="top-1" width="40" class="rounded ms-3" />
                      <div class="ms-3">
                    ...
                    <div class="hstack p-3 bg-hover-light-black position-relative border-bottom">
                      ...
                      <img src="../../dist/images/music/album5.jpg" alt="top-1" width="40" class="rounded ms-3" />
                      <div class="ms-3">
                    ...
                    <div class="hstack p-3 bg-hover-light-black position-relative border-bottom">
                      ...
                      <img src="../../dist/images/music/album6.jpg" alt="top-1" width="40" class="rounded ms-3" />
                      <div class="ms-3">
                        <h6 class="mb-0">N95</h6>
                        <span class="fs-3">Roddy Ricch</span>
                      </div>
                    ...
                    <div class="hstack p-3 bg-hover-light-black position-relative">
                      ...
                      <img src="../../dist/images/music/album7.jpg" alt="top-1" width="40" class="rounded ms-3" />
                      <div class="ms-3">
              ...
              <div class="card">
                <div class="card-body p-4">
                  ...
                  <div class="mt-4 card p-3 rounded shadow-none border">
                    <div class="d-flex align-items-center">
                      <div class="position-relative">
                        <img src="../../dist/images/music/album1.jpg" class="rounded" alt="album" width="97" />
                  ...
                  <div class="mt-4 card p-3 rounded shadow-none border">
                    <div class="d-flex align-items-center">
                      <div class="position-relative">
                        <img src="../../dist/images/music/album2.jpg" class="rounded" alt="album" width="97" />
                        <div class="card-img-overlay d-flex align-items-center justify-content-center">
                          <button class="btn btn-primary rounded-circle round p-0">
                            <i class="ti ti-player-play fs-5"></i>
                          </button>
                  ...
                  <div class="mt-4 card mb-0 p-3 rounded shadow-none border">
                    <div class="d-flex align-items-center">
                      <div class="position-relative">
                        <img src="../../dist/images/music/album4.jpg" class="rounded" alt="album" width="97" />
                        <div class="card-img-overlay d-flex align-items-center justify-content-center">
                          <button class="btn btn-primary rounded-circle round p-0">
                            <i class="ti ti-player-play fs-5"></i>
                          </button>
  ...
  <div class="offcanvas offcanvas-end customizer" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" data-simplebar="">
    ...
    <script src="../../dist/js/jplayer/jplayer.js"></script>
    <script src="../../dist/libs/jplayer/dist/jplayer/jquery.jplayer.min.js"></script>
    <script src="../../dist/libs/jplayer/dist/add-on/jplayer.playlist.min.js"></script>
  </body>

<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/index6.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:51:58 GMT -->
</html>