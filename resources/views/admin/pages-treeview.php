...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/pages-treeview.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:54:29 GMT -->
<head>
    <!--  Title -->
                    ...
                    <div class="col-sm-4">
                      ...
                      <div class="form-check">
                        <input
                          ...
                          id="chk-ignore-case"
                        />
                        <label class="form-check-label" for="chk-ignore-case"
                          >Ignore Case</label
                        >
                      </div>
                      <div class="form-check">
                        <input
                          ...
                          id="chk-exact-match"
                        />
                        <label class="form-check-label" for="chk-exact-match"
                          >Exact Match</label
                        >
                      </div>
                      <div class="form-check">
                        ...
                        />
                        <label class="form-check-label" for="chk-reveal-results"
  ...
  <div class="offcanvas offcanvas-end customizer" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" data-simplebar="">
    ...
    <script src="../../dist/libs/bootstrap-tree/dist/bootstrap-treeview.min.js"></script>
    <script src="../../dist/js/plugins/bootstrap-treeview-init.js"></script>
  </body>

<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/pages-treeview.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:54:30 GMT -->
</html>