...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-actions.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:53:59 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
                  ...
                  <form>
                    <div class="card-body">
                      ...
                      <p class="card-subtitle mb-3">
                        To use add form actions on top of the form add a div
                        with
                        <mark><code>.action-form</code></mark> class to begining
                        the form.
                      </p>
                      <div
                        class="alert bg-light-primary text-primary alert-dismissible fade show"
                        role="alert"
                      >
                        <div
                          class="d-flex align-items-center text-primary font-medium"
                        >
                ...
                <div class="card w-100">
                  <div class="card-body pb-0">
                    ...
                    <p class="card-subtitle mb-3">
                      ...
                      <mark><code>.action-form</code></mark> class to ending the
                      form.
                    </p>
                    <div
                      class="alert bg-light-primary text-info alert-dismissible fade show"
                      role="alert"
                    >
                      <div
                        class="d-flex align-items-center text-primary font-medium"
                  ...
                  <div class="card-body border-top">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-12 col-md-6">
                        <div class="mb-3">
                          <label for="wen1" class="control-label col-form-label"
                            >Website</label
                          >
                          <input
                            type="text"
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="mb-3">
                          <label for="cono" class="control-label col-form-label"
                            >Contact No</label
                          >
                          <input
                            type="text"
                  ...
                  <form>
                    <div class="card-body">
                      ...
                      <p class="card-subtitle mb-3 mt-3">
                        To use add form actions on top of the form add a div
                        with
                        <mark><code>.action-form</code></mark> class to the
                        ending of the form. To set a side of the button use
                        <mark><code>.text-center</code></mark> as per
                        requirement.
                      </p>
                      <div
                        class="alert bg-light-primary text-primary alert-dismissible fade show"
                ...
                <div class="card w-100">
                  <form>
                    <div class="card-body">
                      ...
                      <p class="card-subtitle mt-3 mb-3">
                        To use add form actions on top of the form add a div
                        with
                        <mark><code>.action-form</code></mark> class to the
                        ending of the form. To set a side of the button use
                  ...
                  <form>
                    <div class="card-body">
                      ...
                      <p class="card-subtitle mb-3">
                        ...
                        with
                        <mark><code>.action-form</code></mark> class to begining
                        and ending of the form. To set a side of the button use
                        <mark><code>.text-start</code></mark> or
                        <mark><code>.text-start</code></mark> as per
                        requirement.
                      </p>
                      <div
                        class="alert bg-light-primary text-info alert-dismissible fade show"
                  ...
                  <form>
                    <div class="card-body">
                      ...
                      <p class="card-subtitle mb-3">
                        ...
                        <mark><code>.action-form</code></mark> class to begining
                        and ending of the form. To set a side of the button use
                        <mark><code>.text-end</code></mark> or
                        <mark><code>.text-start</code></mark> as per
                        requirement.
                      </p>
                      <div
                ...
                <div class="card">
                  <form>
                    <div class="card-body">
                      ...
                      <p class="card-subtitle mb-3">
                        To use add class
                        <mark><code>.action-form</code></mark> at which side you
                        want to add buttons.
                      </p>
                      <div
                        class="alert bg-light-primary text-info alert-dismissible fade show"
