...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/ui-badge.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:41 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
        ...
        <div class="container-fluid">
          ...
          <section>
            <div class="row"> 
                  ...
                  <div class="card-body">
                    ...
                    <div class="row gap-2">
                      ...
                      <div class="col-md-5">
                        ...
                        >
                          Info <span class="badge ms-auto bg-info">2</span>
                        </button>
                      </div>
                      <div class="col-md-5">
                        <button
                        ...
                        >
                          Warning
                          <span class="badge ms-auto bg-warning">3</span>
                        </button>
                      </div>
                      <div class="col-md-5">
                        <button
                          type="button"
                          class="btn d-flex btn-light-danger w-100 d-block text-danger font-medium"
                        >
                          Danger <span class="badge ms-auto bg-danger">4</span>
                        </button>
                      </div>
                      <div class="col-md-5">
                        <button
                          type="button"
                          class="btn d-flex btn-light-success w-100 d-block text-success font-medium"
                        >
                          Success
                          <span class="badge ms-auto bg-success">5</span>
                        </button>
                      </div>
                      <div class="col-md-5">
                        <button
                          type="button"
                          class="btn d-flex btn-light-secondary w-100 d-block text-secondary font-medium"
                        >
                          Secondary
                          <span class="badge ms-auto bg-secondary">6</span>
                        </button>
                      </div>
                    </div>
                    ...
                    <div class="row gap-2 mt-2">
                      <div class="col-md-5">
                        <button
                          ...
                          class="btn d-flex btn-light-primary w-100 d-block text-primary font-medium"
                        >
                          <span class="badge me-auto bg-primary">1</span>Primary
                        </button>
                      </div>
                      <div class="col-md-5">
                        <button
                          ...
                          class="btn d-flex btn-light-info w-100 d-block text-info font-medium"
                        >
                          <span class="badge me-auto bg-info">2</span> Info
                        </button>
                      </div>
                      <div class="col-md-5">
                        <button
                          ...
                          class="btn d-flex btn-light-warning w-100 d-block text-warning font-medium"
                        >
                          <span class="badge me-auto bg-warning">3</span>
                          Warning
                        </button>
                      </div>
                      <div class="col-md-5">
                        <button
                          ...
                          class="btn d-flex btn-light-danger w-100 d-block text-danger font-medium"
                        >
                          <span class="badge me-auto bg-danger">4</span> Danger
                        </button>
                      </div>
                      <div class="col-md-5">
                        <button
                          ...
                          class="btn d-flex btn-light-success w-100 d-block text-success font-medium"
                        >
                          <span class="badge me-auto bg-success">5</span>
                          Success
                        </button>
                      </div>
                      <div class="col-md-5">
                        <button
                          ...
                          class="btn d-flex btn-light-secondary w-100 d-block text-secondary font-medium"
                        >
                          <span class="badge me-auto bg-secondary">6</span>
                          Secondary
                        </button>
                      </div>
                    </div>
              ...
              <div class="col-lg-6 d-flex align-items-stretch">
                ...
                <div class="card w-100">
                  <div class="card-body">
                    ...
                    <span class="mb-1 badge bg-primary">Primary</span>
                    ...
                    <span class="mb-1 badge bg-light">Light</span>
                    ...
                    >
                    <span
                      class="mb-1 badge font-medium bg-light-secondary text-secondary"
                      >Secondary</span
                    >
                    <span
                      class="mb-1 badge font-medium bg-light-success text-success"
                      >Success</span
                    >
                    <span
                      class="mb-1 badge font-medium bg-light-danger text-danger"
                      >Danger</span
                    >
                    <span
                      class="mb-1 badge font-medium bg-light-warning text-warning"
                      >Warning</span
                    >
              ...
              <div class="col-lg-6 d-flex align-items-stretch">
                <!-- ---------------------
                                                      start Badges Pill with Background
                                                  ---------------- -->
                <div class="card w-100">
                  <div class="card-body">
                    <div class="mb-4">
                    ...
                    <span class="mb-1 badge rounded-pill bg-secondary"
                      >Secondary</span
                    >
                    <span class="mb-1 badge rounded-pill bg-success"
                      >Success</span
                    >
                    <span class="mb-1 badge rounded-pill bg-danger"
                      >Danger</span
                    >
                    <span class="mb-1 badge rounded-pill bg-warning"
                      >Warning</span
                    >
                    <span class="mb-1 badge rounded-pill bg-info">Info</span>
                    <span class="mb-1 badge rounded-pill bg-light">Light</span>
                    <span class="mb-1 badge rounded-pill bg-dark">Dark</span>
                    ...
                    >
                    <span
                      class="mb-1 badge rounded-pill font-medium bg-light-secondary text-secondary"
                      >Secondary</span
                    >
                    <span
                      class="mb-1 badge rounded-pill font-medium bg-light-success text-success"
                      >Success</span
                    >
                    <span
                      class="mb-1 badge rounded-pill font-medium bg-light-danger text-danger"
                      >Danger</span
                    >
                    <span
                      class="mb-1 badge rounded-pill font-medium bg-light-warning text-warning"
                      >Warning</span
                    >
                    <span
                      class="mb-1 badge rounded-pill font-medium bg-light-info text-info"
                      >Info</span
                    >
                  </div>
                </div>
                <!-- ---------------------
                                                      end Badges Pill with Background
                                                  ---------------- -->
              </div>
            </div>
          </section>
