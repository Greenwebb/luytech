...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/eco-checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:25 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
            ...
            <div class="card-body p-4">
              <div class="wizard-content">                  
                <form action="#" class="tab-wizard wizard-circle">
                      ...
                      <table class="table align-middle text-nowrap mb-0">
                        ...
                        <tbody>
                          <tr>                          
                            ...
                            <td class="text-end border-bottom-0"><h6 class="fs-4 fw-semibold mb-0">$285</h6></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                      ...
                      <div class="payment-option btn-group-active  card shadow-none border">
                        <div class="card-body p-4">
                          ...
                          <div class="row">
                                ...
                                <div class="position-relative col-12 mb-3">
                                  ...
                                  <label class="btn btn-outline-primary mb-0 p-3 rounded ps-5 w-100" for="btnradio3">
                                    <div class="d-flex align-items-center">
                                      ...
                                      <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/paypal.svg" alt="" class="img-fluid ms-auto"> 
                                    </div>
                                  </label>
                                </div>
                                <div class="position-relative col-12 mb-3">
                            ...
                            <div class="col-lg-4">
                              <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/products/payment.svg" alt="" class="img-fluid">
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <section class="payment-method text-center">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between my-4">
                      <a href="eco-checkout.php" class="btn btn-success d-block mb-2 mb-sm-0">Continue Shopping</a>
                ...
                <!-- <div class="text-center my-4">
                  ...
                  <a href="./shop.php" class="btn btn-primary">Go back to Shopping</a>
                </div> -->
              </div>
            </div>
          </div>
...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/eco-checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:27 GMT -->
</html>