...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/widgets-cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:29 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-sm-6 col-lg-4 col-xl-2">
              <a href="page-user-profile.php" class="p-4 text-center bg-light-primary card shadow-none rounded-2">
                <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/icon-user-male.svg" width="50" height="50" class="mb-6 mx-auto" alt="">
            ...
            <div class="col-sm-6 col-lg-4 col-xl-2">
              <a href="javascript:void(0)" class="p-4 text-center bg-light-warning card shadow-none rounded-2">
                <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/icon-briefcase.svg" width="50" height="50" class="mb-6 mx-auto" alt="">
                <p class="fw-semibold text-warning mb-1">Blog</p>
                <h4 class="fw-semibold text-warning mb-0">256</h4>
              </a>
            </div>
            <div class="col-sm-6 col-lg-4 col-xl-2">
              <a href="app-calendar.php" class="p-4 text-center bg-light-info card shadow-none rounded-2">
                <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/icon-mailbox.svg" width="50" height="50" class="mb-6 mx-auto" alt="">
                <p class="fw-semibold text-info mb-1">Calendar</p>
                <h4 class="fw-semibold text-info mb-0">932</h4>
              </a>
            </div>
            <div class="col-sm-6 col-lg-4 col-xl-2">
              <a href="app-email.php" class="p-4 text-center bg-light-danger card shadow-none rounded-2">
                <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/icon-favorites.svg" width="50" height="50" class="mb-6 mx-auto" alt="">
                <p class="fw-semibold text-danger mb-1">Email</p>
                <h4 class="fw-semibold text-danger mb-0">$348K</h4>
              </a>
            </div>
            <div class="col-sm-6 col-lg-4 col-xl-2">
              <a href="app-chat.php" class="p-4 text-center bg-light-success card shadow-none rounded-2">
                <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/icon-speech-bubble.svg" width="50" height="50" class="mb-6 mx-auto" alt="">
                <p class="fw-semibold text-success mb-1">Chats</p>
                <h4 class="fw-semibold text-success mb-0">96</h4>
              </a>
            </div>
            <div class="col-sm-6 col-lg-4 col-xl-2">
              <a href="app-contact.php" class="p-4 text-center bg-light-info card shadow-none rounded-2">
                <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/icon-connect.svg" width="50" height="50" class="mb-6 mx-auto" alt="">
            ...
            <div class="col-lg-4">
              <div class="card rounded-2 overflow-hidden hover-img">
                <div class="position-relative">
                  ...
                  <img src="../../dist/images/profile/user-1.jpg" alt="" class="img-fluid rounded-circle position-absolute bottom-0 start-0 mb-n9 ms-9" width="40" height="40" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Georgeanna Ramero">
                </div>
                <div class="card-body p-4">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    ...
                    <div class="d-flex align-items-center fs-2 ms-auto"><i class="ti ti-point text-dark"></i>Mon, Dec 19</div>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card rounded-2 overflow-hidden hover-img">
                <div class="position-relative">
                  ...
                  <span class="badge bg-white text-dark fs-2 rounded-4 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2 min Read</span>
                  <img src="../../dist/images/profile/user-2.jpg" alt="" class="img-fluid rounded-circle position-absolute bottom-0 start-0 mb-n9 ms-9" width="40" height="40" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Georgeanna Ramero">
                </div>
                <div class="card-body p-4">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    ...
                    <div class="d-flex align-items-center fs-2 ms-auto"><i class="ti ti-point text-dark"></i>Sun, Dec 18</div>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card rounded-2 overflow-hidden hover-img">
                <div class="position-relative">
                  ...
                  <span class="badge bg-white text-dark fs-2 rounded-4 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2 min Read</span>
                  <img src="../../dist/images/profile/user-3.jpg" alt="" class="img-fluid rounded-circle position-absolute bottom-0 start-0 mb-n9 ms-9" width="40" height="40" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Georgeanna Ramero">
                </div>
                <div class="card-body p-4">
                  ...
                  <div class="d-flex align-items-center gap-4">
                    ...
                    <div class="d-flex align-items-center fs-2 ms-auto"><i class="ti ti-point text-dark"></i>Sat, Dec 17</div>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="row">
                  <div class="col-6 pe-0">
                    ...
                    <ul class="d-flex align-items-center justify-content-between mb-0 list-unstyled px-3 pb-7">
                      <li><a href="javascript:void(0)" class="text-muted p-2"><i class="ti ti-player-skip-back fs-5"></i></a></li>
                      <li><a href="javascript:void(0)" class="text-danger p-2"><i class="ti ti-player-play fs-5"></i></a></li>
                      <li><a href="javascript:void(0)" class="text-muted p-2"><i class="ti ti-player-skip-forward fs-5"></i></a></li>
                    </ul>  
                  </div>
                  <div class="col-6 ps-0">
                    <div class="position-relative w-100 h-100">
                      <img src="../../dist/images/blog/blog-img5.jpg" class="w-100 h-100 rounded-0" alt="">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-4">
              <div class="card rounded-2 overflow-hidden">
                <div class="row">
                  ...
                  <div class="col-6 ps-0">
                    <div class="position-relative w-100 h-100">
                      <img src="../../dist/images/blog/blog-img4.jpg" class="w-100 h-100 rounded-0" alt="">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-4">
              <div class="card rounded-2 overflow-hidden">
                <div class="row">
                  ...
                  <div class="col-6 ps-0">
                    <div class="position-relative w-100 h-100">
                      <img src="../../dist/images/blog/blog-img3.jpg" class="w-100 h-100 rounded-0" alt="">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-body p-4 d-flex align-items-center gap-3">
                  ...
                  <div>
                    ...
                    <span class="fs-2 d-flex align-items-center"><i class="ti ti-map-pin text-dark fs-3 me-1"></i>Bulgaria</span>
                  </div>
                  <button class="btn btn-primary py-1 px-2 ms-auto">Follow</button>
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-body p-4 d-flex align-items-center gap-3">
                  ...
                  <div>
                    ...
                    <span class="fs-2 d-flex align-items-center"><i class="ti ti-map-pin text-dark fs-3 me-1"></i>Nepal</span>
                  </div>
                  <button class="btn btn-primary py-1 px-2 ms-auto">Follow</button>
                </div>
              </div>
          ...
          <div class="row">
            <div class="col-sm-6 col-lg-3">
              <div class="card">
                <div class="card-body p-4">
                  <img src="../../dist/images/profile/user-1.jpg" alt="" class="img-fluid rounded-circle mb-4" width="80" height="80">
                  <h5 class="mb-2 fw-semibold fs-4">Andrew Grant</h5>
                  <div class="d-flex align-items-center gap-4 mb-4">
                    <div class="d-flex align-items-center">
                      <a href="#">
                        <img src="../../dist/images/profile/user-1.jpg" class="rounded-circle me-n2 card-hover border border-white" width="32" height="32">
                      </a>
                      <a href="#">
                        <img src="../../dist/images/profile/user-2.jpg" class="rounded-circle me-n2 card-hover border border-white" width="32" height="32">
                      </a>
                      <a href="#">
                        <img src="../../dist/images/profile/user-3.jpg" class="rounded-circle me-n2 card-hover border border-white" width="32" height="32">
                      </a>
                    </div>
                    <p class="mb-0">3 mutual friends</p>
                  </div>
                  <button class="btn bg-light-primary text-primary mb-3 w-100">Add Friend</button>
                  <button class="btn bg-light-secondary text-secondary w-100">Remove</button>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-lg-3">
              <div class="card">
                <div class="card-body p-4">
                  <img src="../../dist/images/profile/user-2.jpg" alt="" class="img-fluid rounded-circle mb-4" width="80" height="80">
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="card">
                <div class="card-body p-4">
                  <img src="../../dist/images/profile/user-3.jpg" alt="" class="img-fluid rounded-circle mb-4" width="80" height="80">
            ...
            <div class="col-sm-6 col-lg-3">
              <div class="card">
                <div class="card-body p-4">
                  <img src="../../dist/images/profile/user-4.jpg" alt="" class="img-fluid rounded-circle mb-4" width="80" height="80">
              ...
              <div class="card">
                <div class="card-body p-4">
                  ...
                  <div class="d-flex align-items-center gap-3 pb-3 mb-3 border-bottom">
                    <div class="d-flex align-items-center">
                      <div class="bg-primary rounded-2 d-flex align-items-center justify-content-center p-6">
                  ...
                  <div class="d-flex align-items-center gap-3 pb-3 border-bottom mb-3">
                    <div class="d-flex align-items-center">
                      <div class="bg-secondary rounded-2 d-flex align-items-center justify-content-center p-6">
                  ...
                  <div class="text-end">
                    <button class="btn btn-outline-danger me-3">Cencel</button>
            ...
            <div class="col-md-4">
              <div class="card">
                <div class="card-body p-4">
                  ...
                  <img src="../../dist/images/products/s1.jpg" alt="" class="img-fluid rounded-4 w-100 object-fit-cover mb-4" style="height: 160px;">
            ...
            <div class="col-md-4">
              <div class="card">
                <div class="card-body p-4">
                  ...
                  <img src="../../dist/images/products/s2.jpg" alt="" class="img-fluid rounded-4 w-100 object-fit-cover mb-4" style="height: 160px;">
                  <button class="btn btn-primary w-100 fw-normal py-8">Gift to Friend ($50.00)</button>
                </div>
              </div>
            </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      <div class="d-flex">
                        <div class="p-8 bg-light-primary rounded-2 d-flex align-items-center justify-content-center me-6">
                          <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/icon-paypal.svg" alt="" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      <div class="d-flex">
                        <div class="p-8 bg-light-success rounded-2 d-flex align-items-center justify-content-center me-6">
                          <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/icon-office-bag.svg" alt="" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      <div class="d-flex">
                        <div class="p-8 bg-light-warning rounded-2 d-flex align-items-center justify-content-center me-6">
                          <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/icon-master-card.svg" alt="" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-7 pb-8">
                      <div class="d-flex">
                        <div class="p-8 bg-light-danger rounded-2 d-flex align-items-center justify-content-center me-6">
                          <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/icon-pie.svg" alt="" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                ...
                <div class="card-body p-4">
                  ...
                  <div class="position-relative">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      <div class="d-flex">
                        <div class="p-8 bg-light-primary rounded-2 d-flex align-items-center justify-content-center me-6">
                          <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/icon-map-pin.svg" alt="" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      <div class="d-flex">
                        <div class="p-8 bg-light-info rounded-2 d-flex align-items-center justify-content-center me-6">
                          <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/icon-database.svg" alt="" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      <div class="d-flex">
                        <div class="p-8 bg-light-warning rounded-2 d-flex align-items-center justify-content-center me-6">
                          <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/icon-phone.svg" alt="" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                      <div class="d-flex">
                        <div class="p-8 bg-light-danger rounded-2 d-flex align-items-center justify-content-center me-6">
                          <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/icon-screen-share.svg" alt="" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                      <div class="d-flex">
                        <div class="p-8 bg-light-success rounded-2 d-flex align-items-center justify-content-center me-6">
                          <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/svgs/icon-mail.svg" alt="" class="img-fluid" width="24" height="24">
                        </div>
                        <div>
...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/widgets-cards.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:30 GMT -->
</html>