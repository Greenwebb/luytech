...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/table-layout-coloured.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:54:01 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
      ...
      <div class="body-wrapper">
        ...
        <div class="container-fluid">
          <!-- --------------------------------------------------- -->
          <!--  Table Coloured Start -->
          <!-- --------------------------------------------------- -->
          <div class="card bg-light-info shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
              <div class="row align-items-center">
                <div class="col-9">
                  <h4 class="fw-semibold mb-8">Table Layout Coloured</h4>
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item"><a class="text-muted " href="{{ route('index') }}">Dashboard</a></li>
                      <li class="breadcrumb-item" aria-current="page">Table Layout Coloured</li>
                    </ol>
                  </nav>
                </div>
                <div class="col-3">
...
&lt;/div&gt;
                    ...
                    <p class="card-subtitle mb-3">
                      To use add class <code>.bg-inverse .text-white</code> in
                      the <code>&lt;thead&gt;</code>.
                    </p>
                    <div class="table-responsive">
                      <table class="table border">
...
&lt;/div&gt;
                    ...
                    <div class="table-responsive">
                      <table
                        class="table table-hover table-primary text-dark table-borderless"
                      >
                        <thead>
                          <!-- start row -->
                          <tr>
...
&lt;/div&gt;
                    ...
                    <div class="table-responsive">
                      <table
                        class="table table-hover table-success text-dark table-borderless"
                      >
                        <thead>
                          <!-- start row -->
                          <tr>
...
&lt;/div&gt;
                    ...
                    <div class="table-responsive">
                      <table
                        class="table table-hover table-info text-dark table-borderless"
                      >
                        <thead>
                          <!-- start row -->
                          <tr>
...
&lt;/div&gt;
                    ...
                    <div class="table-responsive">
                      <table
                        class="table table-hover table-warning text-dark table-borderless"
                      >
                        <thead>
                          <!-- start row -->
                          <tr>
...
&lt;/div&gt;
                    ...
                    <div class="table-responsive">
                      <table
                        class="table table-hover table-danger text-dark table-borderless"
                      >
                        <thead>
                          <!-- start row -->
                          <tr>
...
&lt;/div&gt;
                    ...
                    <div class="table-responsive">
                      <table
                        class="table table-hover table-dark table-borderless"
                      >
                        <thead>
                          <!-- start row -->
                          <tr>
