...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/ui-accordian.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:40 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
          ...
          <section>
            <div class="row">
                ...
                <div class="card w-100">
                  <div class="card-body">
                    ...
                    <p class="button-group">
                      <a
                        class="btn btn-light-info mb-2 font-medium text-info px-4 rounded-pill"
                        data-bs-toggle="collapse"
              ...
              <div class="col-lg-7 d-flex align-items-stretch">
                <!-- ---------------------
                            start Collapse with multiple targets
                        ---------------- -->
                <div class="card w-100">
                  <div class="card-body">
                    <div class="mb-4">
                    ...
                    <div class="button-group">
                      <a
                        class="btn btn-light-primary mb-2 text-primary px-4 rounded-pill font-medium"
                        data-bs-toggle="collapse"
                      ...
                      >
                      <button
                        class="btn btn-light-success mb-2 text-success px-4 rounded-pill font-medium"
                        type="button"
                        data-bs-toggle="collapse"
                      ...
                      <button
                        class="btn btn-light-danger mb-2 text-danger px-4 rounded-pill font-medium"
                        type="button"
                        data-bs-toggle="collapse"
                ...
                <!-- ---------------------
                            end Collapse with multiple targets
                        ---------------- -->
              </div>
            </div>
          </section>
...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/ui-accordian.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:41 GMT -->
</html>
