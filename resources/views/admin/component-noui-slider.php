...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/component-noui-slider.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:53:07 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
    ...
    <link rel="stylesheet" href="../../dist/libs/nouislider-orxe/distribute/nouislider.min.css">
    <!-- --------------------------------------------------- -->
    <!-- Core Css -->
    <!-- --------------------------------------------------- -->
                  ...
                  <fieldset>
                    ...
                    <div class="mb-3 mt-2">
                      <div
                        ...
                        class="circle-filled slider-success"
                      ></div>
                    </div>
                  </fieldset>
                  <fieldset>
                  ...
                  <fieldset>
                    ...
                    <div class="mb-3 mt-2">
                      <div
                        ...
                        class="circle-filled slider-danger"
                      ></div>
                    </div>
                  </fieldset>
                  <fieldset>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <fieldset>
                    ...
                    <div class="mb-3 mt-2">
                      <div
                        class="slider-lg slider-success"
                        id="large-slider"
                      ></div>
                    </div>
                  </fieldset>
                  ...
                  <fieldset>
                    ...
                    <div class="mb-3 mt-2">
                      <div
                        class="slider-sm slider-warning"
                        id="small-slider"
                      ></div>
                    </div>
                  </fieldset>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <fieldset>
                    ...
                    <div class="mb-3 mt-2">
                      <div
                        class="circle-filled slider-lg slider-success"
                  ...
                  <fieldset>
                    ...
                    <div class="mb-3 mt-2">
                      <div
                        class="circle-filled slider-info"
                  ...
                  <fieldset>
                    ...
                    <div class="mb-3 mt-2">
                      <div
                        class="circle-filled slider-sm slider-warning"
                  ...
                  <fieldset>
                    ...
                    <div class="mb-3 mt-2">
                      <div
                        class="circle-filled slider-xs slider-danger"
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <fieldset>
                    ...
                    <div class="mb-3 mt-2">
                      <div
                        class="square slider-lg slider-success"
                  ...
                  <fieldset>
                    ...
                    <div class="mb-3 mt-2">
                      <div
                        class="square slider-sm slider-warning"
                  ...
                  <fieldset>
                    ...
                    <div class="mb-3 mt-2">
                      <div
                        class="square slider-xs slider-danger"
                ...
                <div class="card-body">
                  ...
                  <fieldset class="mt-3">
                    <div class="form-group text-center">
                      ...
                      <div
                        id="slider-vertical-2"
                        class="ms-3 slider-info"
                      ></div>
                      <div
                        id="slider-vertical-3"
                        class="ms-3 slider-success"
                      ></div>
                      <div
                        id="slider-vertical-4"
                        class="ms-3 slider-warning"
                      ></div>
                      <div
                        id="slider-vertical-5"
                        class="ms-3 slider-danger"
                      ></div>
                    </div>
                  </fieldset>
                </div>
                  ...
                  <fieldset class="mt-3">
                    <div class="form-group text-center">
                      ...
                      <div
                        ...
                        class="ms-5 me-4 slider-info"
                      ></div>
                      <div
                        id="slider-tooltips-3"
                        class="ms-5 slider-warning"
                      ></div>
                    </div>
                  </fieldset>
                </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <fieldset class="mt-3">
                    <div class="form-group text-center">
                      <div
                        id="slider-direction-top-bottom-1"
                        class="me-4"
                      ></div>
                      <div
                        id="slider-direction-top-bottom-2"
                        class="ms-5 me-4 slider-warning"
                      ></div>
                      <div
                        id="slider-direction-top-bottom-3"
                        class="ms-5 slider-danger"
                      ></div>
                    </div>
                  </fieldset>
                </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <fieldset class="mt-3">
                    <div class="form-group text-center">
                      <div
                        id="slider-direction-bottom-top-1"
                        class="me-4"
                      ></div>
                      <div
                  ...
                  <fieldset class="mt-3">
                    <div class="form-group text-center">
                      ...
                      <div
                        ...
                        class="circle-filled ms-3 slider-info"
                      ></div>
                      <div
                        id="vert-circle-default-slider"
                        class="circle-filled ms-3 slider-success"
                      ></div>
                      <div
                        id="vert-circle-small-slider"
                        class="circle-filled ms-3 slider-warning"
                      ></div>
                      <div
                        id="vert-circle-extra-small-slider"
                        class="circle-filled ms-3 slider-danger"
                      ></div>
                    </div>
                  </fieldset>
                </div>
                  ...
                  <fieldset class="mt-3">
                    <div class="form-group text-center">
                      ...
                      <div
                        ...
                        class="square ms-3 slider-info"
                      ></div>
                      <div
                        id="vert-square-default-slider"
                        class="square ms-3 slider-success"
                      ></div>
                      <div
                        id="vert-square-small-slider"
                        class="square ms-3 slider-warning"
                      ></div>
                      <div
                        id="vert-square-extra-small-slider"
                        class="square ms-3 slider-danger"
                      ></div>
                    </div>
                  </fieldset>
                </div>
  ...
  <div class="offcanvas offcanvas-end customizer" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" data-simplebar="">
    ...
    <!-- ---------------------------------------------- -->
    <script src="../../dist/libs/wnumb/wNumb.min.js"></script>  
    <script src="../../dist/libs/nouislider-orxe/distribute/nouislider.min.js"></script>
    <script src="../../dist/js/plugins/nouislider-init.js"></script>
  </body>

<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/component-noui-slider.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:53:10 GMT -->
</html>
