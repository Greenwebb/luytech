...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/ui-notification.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:52:45 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
                ...
                <div class="card w-100">
                  <div class="card-body">
                    ...
                    <p class="mb-3 card-subtitle">
                      ...
                      <mark><code>.alert-success</code></mark
              ...
              <div class="col-lg-6 d-flex align-items-stretch">
                ...
                <div class="card w-100">
                  <div class="card-body">
                    ...
                    <div
                      class="alert alert-secondary alert-dismissible bg-secondary text-white border-0 fade show"
                      role="alert"
                    >
                      <button
                        type="button"
              ...
              <div class="col-lg-6 d-flex align-items-stretch">
                ...
                <div class="card w-100">
                  <div class="card-body">
                    ...
                    <div
                      class="alert customize-alert alert-dismissible border-info text-info fade show remove-close-icon"
                      role="alert"
                    >
                      <button
                        type="button"
              ...
              <div class="col-lg-6 d-flex align-items-stretch">
                ...
                <div class="card w-100">
                  <div class="card-body">
                    ...
                    <div
                      class="alert customize-alert alert-dismissible text-primary text-primary alert-light-primary fade show remove-close-icon"
                      role="alert"
                    >
                      <button
                        type="button"
                    ...
                    <div
                      class="alert customize-alert alert-dismissible text-secondary alert-light-secondary fade show remove-close-icon"
                      role="alert"
                    >
                      <button
                        type="button"
                    ...
                    <div
                      class="alert customize-alert alert-dismissible text-success alert-light-success fade show remove-close-icon"
                      role="alert"
                    >
                      <button
                        type="button"
                    ...
                    <div
                      class="alert customize-alert alert-dismissible alert-light-danger text-danger fade show remove-close-icon"
                      role="alert"
                    >
                      <button
                        type="button"
                    ...
                    <div
                      class="alert customize-alert alert-dismissible alert-light-warning text-warning fade show remove-close-icon"
                      role="alert"
                    >
                      <button
                        type="button"
                    ...
                    <div
                      class="alert customize-alert alert-dismissible alert-light-info text-info fade show remove-close-icon"
                      role="alert"
                    >
                      <button
                        type="button"
              ...
              <div class="col-lg-6 d-flex align-items-stretch">
                ...
                <div class="card w-100">
                  <div class="card-body">
                    ...
                    <div
                      class="alert customize-alert alert-dismissible text-primary rounded-pill alert-light-primary fade show remove-close-icon"
                      role="alert"
                    >
                      <button
                        type="button"
                    ...
                    <div
                      class="alert customize-alert alert-dismissible text-secondary rounded-pill alert-light-secondary fade show remove-close-icon"
                      role="alert"
                    >
                      <button
                        type="button"
                    ...
                    <div
                      class="alert customize-alert alert-dismissible text-success rounded-pill alert-light-success text-success fade show remove-close-icon"
                      role="alert"
                    >
                      <button
                        type="button"
                    ...
                    <div
                      class="alert customize-alert alert-dismissible rounded-pill alert-light-danger text-danger fade show remove-close-icon"
                      role="alert"
                    >
                      <button
                        type="button"
                    ...
                    <div
                      class="alert customize-alert alert-dismissible rounded-pill alert-light-warning text-warning fade show remove-close-icon"
                      role="alert"
                    >
                      <button
                        type="button"
                    ...
                    <div
                      class="alert customize-alert alert-dismissible rounded-pill alert-light-info text-info fade show remove-close-icon"
                      role="alert"
                    >
                      <button
                        type="button"
              ...
              <div class="col-lg-6 d-flex align-items-stretch">
                ...
                <div class="card w-100">
                  <div class="card-body">
                    ...
                    <div
                      class="alert customize-alert alert-dismissible text-primary alert-light-primary fade show remove-close-icon"
                      role="alert"
                    >
                    ...
                    >
                      ...
                      <div class="d-flex align-items-center font-medium">
                        ...
                        <span class="text-truncate"
                          >A secondary outline alert</span
                        >
                        <div class="ms-auto d-flex justify-content-end">
                          <a
                            href="javascript:void(0)"
                    ...
                    <div
                      class="alert customize-alert alert-dismissible text-danger alert-light-danger fade show remove-close-icon"
                      role="alert"
                    >
                    ...
                    <div
                      class="alert customize-alert alert-dismissible text-warning alert-light-warning fade show remove-close-icon"
                      role="alert"
                    >
                    ...
                    <div
                      class="alert customize-alert alert-dismissible text-info alert-light-info fade show remove-close-icon"
                      role="alert"
                    >
              ...
              <div class="col-lg-6 d-flex align-items-stretch">
                ...
                <div class="card w-100">
                  <div class="card-body">
                    ...
                    <div
                      class="alert alert-light-success text-success"
                      role="alert"
                    >
                    ...
                    <div
                      class="alert alert-light-danger text-danger"
                      role="alert"
                    >
