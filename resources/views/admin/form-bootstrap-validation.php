...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-bootstrap-validation.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:53:33 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <form class="needs-validation" novalidate>
                    ...
                    <button class="btn btn-info mt-3 rounded-pill px-4" type="submit">
                      Submit form
                    </button>
                  </form>
                </div>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <form class="needs-validation" novalidate>
                    ...
                    <button class="btn btn-info rounded-pill px-4 mt-4" type="submit">
                      Submit form
                    </button>
                  </form>
                </div>
