...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/authentication-maintenance.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:54:31 GMT -->
<head>
    <!--  Title -->
          ...
          <div class="row justify-content-center w-100">
            <div class="col-lg-4">
              <div class="text-center">
                ...
                <a class="btn btn-primary" href="{{ route('index') }}" role="button">Go Back to Home</a>
              </div>
            </div>
          </div>
        </div>
