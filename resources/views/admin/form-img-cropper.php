...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-img-cropper.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:53:24 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
        ...
        <div class="container-fluid">
                  ...
                  <div class="row">
                    <div class="col-md-9">
                      ...
                      <div class="img-container">
                        <img id="image" src="../../dist/images/backgrounds/cropper-img.jpg" alt="Picture" />
                      </div>
                    </div>
                    <div class="col-md-3">
                      <!-- <h3>Preview:</h3> -->
          ...
          <div class="row">
            <div class="col-md-9 docs-buttons">
              ...
              <button type="button" class="btn btn-secondary" data-method="setData" data-bs-target="#putData">
                <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
              ...
              <button type="button" class="btn btn-secondary" data-method="setCanvasData" data-bs-target="#putData">
                <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
              ...
              <button type="button" class="btn btn-secondary" data-method="setCropBoxData" data-bs-target="#putData">
                <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
            ...
            <div class="col-md-3 docs-toggles">
              <!-- <h3>Toggles:</h3> -->
              <div class="btn-group d-flex flex-wrap" data-bs-toggle="buttons">
  ...
  <div class="offcanvas offcanvas-end customizer" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" data-simplebar="">
    ...
    <script src="../../dist/js/plugins/cropper.init.js"></script>
  </body>

<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/form-img-cropper.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:53:27 GMT -->
</html>
