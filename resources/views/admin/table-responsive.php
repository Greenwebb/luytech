...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/table-responsive.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:54:14 GMT -->
<head>
    <!-- --------------------------------------------------- -->
    <!-- Title -->
    <!-- --------------------------------------------------- -->
        ...
        <div class="container-fluid">
          <div class="card bg-light-info shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8">Table-Responsive</h4>
          ...
          <div class="row">
            <div class="col-12">
                ...
                <div class="card-body">
                  ...
                  <table class="tablesaw table-bordered table-hover table no-wrap" data-tablesaw-mode="swipe"
                    ...
                    <tbody>
                      <tr>
                        <td class="title">
                          <a class="link" href="javascript:void(0)">Avatar</a>
                        </td>
                        <td>1</td>
                        <td>2009</td>
                        <td>83%</td>
                      ...
                      <tr>
                        <td class="title">
                          <a class="link" href="javascript:void(0)">Titanic</a>
                        </td>
                        <td>2</td>
                        <td>1997</td>
                        <td>88%</td>
                      ...
                      <tr>
                        <td class="title">
                          <a class="link" href="javascript:void(0)">The Avengers</a>
                        </td>
                        <td>3</td>
                        <td>2012</td>
                        <td>92%</td>
                      ...
                      <tr>
                        <td class="title">
                          <a class="link" href="javascript:void(0)">Harry Potter and the Deathly Hallows—Part 2</a>
                        </td>
                        <td>4</td>
                        <td>2011</td>
                        <td>96%</td>
                      ...
                      <tr>
                        <td class="title">
                          <a class="link" href="javascript:void(0)">Frozen</a>
                        </td>
                        <td>5</td>
                        <td>2013</td>
                        <td>89%</td>
                      ...
                      <tr>
                        <td class="title">
                          <a class="link" href="javascript:void(0)">Iron Man 3</a>
                        </td>
                        <td>6</td>
                        <td>2013</td>
                        <td>78%</td>
                      ...
                      <tr>
                        <td class="title">
                          <a class="link" href="javascript:void(0)">Transformers: Dark of the Moon</a>
                        </td>
                        <td>7</td>
                        <td>2011</td>
                        <td>36%</td>
                      ...
                      <tr>
                        <td class="title">
                          <a class="link" href="javascript:void(0)">The Lord of the Rings: The Return of the King</a>
                        </td>
                        <td>8</td>
                        <td>2003</td>
                        <td>95%</td>
                      ...
                      <tr>
                        <td class="title">
                          <a class="link" href="javascript:void(0)">Skyfall</a>
                        </td>
                        <td>9</td>
                        <td>2012</td>
                        <td>92%</td>
                      ...
                      <tr>
                        <td class="title">
                          <a class="link" href="javascript:void(0)">Transformers: Age of Extinction</a>
                        </td>
                        <td>10</td>
                        <td>2014</td>
                        <td>18%</td>
              ...
              <div class="card">
                <div class="border-bottom title-part-padding">
                  <h4 class="card-title mb-0">Column Toggle Table</h4>
                </div>
                <div class="card-body">
                  <h5 class="card-subtitle mb-3">
              ...
              <div class="card">
                <div class="border-bottom title-part-padding">
                  <h4 class="card-title mb-0">Swipe Table</h4>
                </div>
                <div class="card-body">
                  <h5 class="card-subtitle mb-3">
                    The Column Swipe Table allows the user to select which
                    columns they want to be visible.
                  </h5>
                  <table class="tablesaw table-bordered table-hover table no-wrap" data-tablesaw-mode="swipe">
                    <thead>
                ...
                <div class="card-body">
                  <table class="tablesaw no-wrap table-bordered table-hover table" data-tablesaw>
                    <thead>
                      <tr>
                        <th scope="col" class="border">
                          <label><input type="checkbox" data-tablesaw-checkall /><span class="sr-only"> Check
                              All</span></label>
                        </th>
                        <th scope="col" class="border">
                          Movie Title
                          <a href="#" data-tablesaw-checkall="#checkall-target">Toggle All Checkboxes</a>
                          <a href="#" data-tablesaw-checkall="#checkall-target" data-tablesaw-checkall-checked>Check
                            All</a>
                          <a href="#" data-tablesaw-checkall="#checkall-target"
                            data-tablesaw-checkall-unchecked>Uncheck All</a>
                        </th>
                    ...
                    <tbody id="checkall-target">
                      <tr>
                        <td>
                          <label><input type="checkbox" /><span class="sr-only">
                              Select Row</span></label>
                        </td>
                        <td class="title">
                      ...
                      <tr>
                        ...
                        <td class="title">
                          <a href="javascript:void(0)">Harry Potter and the Deathly Hallows—Part 2</a>
                        </td>
                        <td>4</td>
                        <td>2011</td>
                        <td>96%</td>
                      ...
                      <tr>
                        ...
                        <td class="title">
                          <a href="javascript:void(0)">Transformers: Dark of the Moon</a>
                        </td>
                        <td>7</td>
                        <td>2011</td>
                        <td>36%</td>
                      ...
                      <tr>
                        ...
                        <td class="title">
                          <a href="javascript:void(0)">The Lord of the Rings: The Return of the King</a>
                        </td>
                        <td>8</td>
                        <td>2003</td>
                        <td>95%</td>
                      ...
                      <tr>
                        ...
                        <td class="title">
                          <a href="javascript:void(0)">Transformers: Age of Extinction</a>
                        </td>
                        <td>10</td>
                        <td>2014</td>
                        <td>18%</td>
              ...
              <div class="card">
                <div class="border-bottom title-part-padding">
                  <h4 class="card-title mb-0">Stack Table</h4>
                </div>
                <div class="card-body">
              ...
              <div class="card">
                <div class="border-bottom title-part-padding">
                  <h4 class="card-title mb-0">Mode Switch</h4>
                </div>
                <div class="card-body">
              ...
              <div class="card">
                <div class="border-bottom title-part-padding">
                  <h4 class="card-title mb-0">Exclude columntoggle Mode</h4>
                </div>
                <div class="card-body">
                  <table class="tablesaw no-wrap table-bordered table-hover table" data-tablesaw-mode="swipe"
...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/table-responsive.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2023 22:54:15 GMT -->
</html>
